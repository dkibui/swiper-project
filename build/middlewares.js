...
function init(settings = default_settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: assets + "/_app/start-e93e8a0b.js",
      css: [assets + "/_app/assets/start-61d1577b.css"],
      js: [assets + "/_app/start-e93e8a0b.js", assets + "/_app/chunks/vendor-336043de.js"]
    },
    fetched: void 0,
    floc: false,
...
var metadata_lookup = { "src/routes/__layout.svelte": { "entry": "pages/__layout.svelte-7f5d43ac.js", "css": ["assets/pages/__layout.svelte-4cf9e234.css"], "js": ["pages/__layout.svelte-7f5d43ac.js", "chunks/vendor-336043de.js"], "styles": [] }, ".svelte-kit/build/components/error.svelte": { "entry": "error.svelte-086a6be9.js", "css": [], "js": ["error.svelte-086a6be9.js", "chunks/vendor-336043de.js"], "styles": [] }, "src/routes/index.svelte": { "entry": "pages/index.svelte-0e9d7df6.js", "css": ["assets/pages/index.svelte-621d7adc.css", "assets/pagination.min-4d3a60e0.css"], "js": ["pages/index.svelte-0e9d7df6.js", "chunks/vendor-336043de.js"], "styles": [] }, "src/routes/about.svelte": { "entry": "pages/about.svelte-542f1110.js", "css": ["assets/pages/about.svelte-e6bbc2b1.css", "assets/pagination.min-4d3a60e0.css"], "js": ["pages/about.svelte-542f1110.js", "chunks/vendor-336043de.js"], "styles": [] }, "src/routes/menu.svelte": { "entry": "pages/menu.svelte-9774df1f.js", "css": [], "js": ["pages/menu.svelte-9774df1f.js", "chunks/vendor-336043de.js"], "styles": [] }, "src/routes/work.svelte": { "entry": "pages/work.svelte-3c781599.js", "css": ["assets/pages/work.svelte-76d95d68.css"], "js": ["pages/work.svelte-3c781599.js", "chunks/vendor-336043de.js"], "styles": [] } };
...
var css$8 = {
  code: ".menu.svelte-s77xgt.svelte-s77xgt{width:93%;margin:0 auto;display:flex;align-items:center;justify-content:space-between;margin-top:0.75rem}.menu.svelte-s77xgt img.svelte-s77xgt{display:block;height:32px}.container.svelte-s77xgt.svelte-s77xgt{cursor:pointer}.bar1.svelte-s77xgt.svelte-s77xgt,.bar2.svelte-s77xgt.svelte-s77xgt,.bar3.svelte-s77xgt.svelte-s77xgt{width:32px;height:3px;background-color:var(--text-color);opacity:85%;margin:8px 0;transition:0.4s}.change.svelte-s77xgt .bar1.svelte-s77xgt{-webkit-transform:rotate(-45deg) translate(-9px, 6px);transform:rotate(-45deg) translate(-9px, 6px)}.change.svelte-s77xgt .bar2.svelte-s77xgt{opacity:0}.change.svelte-s77xgt .bar3.svelte-s77xgt{-webkit-transform:rotate(45deg) translate(-8px, -8px);transform:rotate(45deg) translate(-8px, -8px)}.sidenav.svelte-s77xgt.svelte-s77xgt{height:100%;width:0;position:fixed;z-index:9;top:0;left:0;background-color:var(--primary-color);opacity:0.98999;overflow-x:hidden;padding-top:60px;transition:0.5s}.sidenav.svelte-s77xgt a.svelte-s77xgt{padding:28px 8px 28px 32px;text-decoration:none;font-size:20px;color:var(--text-color);display:block;transition:0.3s;border-bottom:1px solid var(--secondary-color)}.sidenav.svelte-s77xgt a.svelte-s77xgt:first-child{padding-top:17px}.sidenav.svelte-s77xgt a.svelte-s77xgt:first-child,.sidenav.svelte-s77xgt a.svelte-s77xgt:last-child{border-bottom:none}.sidenav.svelte-s77xgt a.svelte-s77xgt:hover{color:#f1f1f1;color:var(--accent-color)}.sidenav.svelte-s77xgt .closebtn.svelte-s77xgt{position:absolute;top:-5px;right:25px;font-size:36px;margin-left:50px}.open.svelte-s77xgt.svelte-s77xgt{width:60%}@media(min-width: 768px){.container.svelte-s77xgt.svelte-s77xgt{display:none}.navigation.svelte-s77xgt.svelte-s77xgt{width:90%;max-width:1600px;margin:auto;display:flex;justify-content:space-between;align-items:center;position:relative;height:fit-content;margin-top:0.75rem}.menu.svelte-s77xgt.svelte-s77xgt{margin:0}.menu.svelte-s77xgt img.svelte-s77xgt{display:block;height:36px}.sidenav.svelte-s77xgt.svelte-s77xgt{display:flex;height:100%;width:100%;position:static;background-color:transparent;padding-top:0;transition:0s;justify-content:flex-end}.sidenav.svelte-s77xgt a.svelte-s77xgt{font-size:18px}.sidenav.svelte-s77xgt a.svelte-s77xgt:first-child{display:none}.sidenav.svelte-s77xgt a.svelte-s77xgt{margin:0;padding:0;padding-left:2.4rem}.sidenav.svelte-s77xgt .closebtn.svelte-s77xgt{position:static;top:0;right:0;font-size:36px;margin-left:0}}",
  map: `{"version":3,"file":"Canvas.svelte","sources":["Canvas.svelte"],"sourcesContent":["<script>\\n  let navOpen = false\\n\\n  function handleNav() {\\n    navOpen = !navOpen\\n  }\\n\\n  function handleNavWithKey(e) {\\n    console.log(e.code)\\n    if (e.code === 'F1') {\\n      navOpen = !navOpen\\n    }\\n  }\\n<\/script>\\n\\n<div class=\\"navigation\\">\\n  <div class=\\"menu\\">\\n    <div class=\\"logo\\">\\n      <a href=\\"/\\"><img src=\\"img/visign-logo.svg\\" alt=\\"visign kenya logo\\" /></a>\\n    </div>\\n    <div class=\\"container\\" class:change={navOpen} on:click={handleNav}>\\n      <div class=\\"bar1\\" />\\n      <div class=\\"bar2\\" />\\n      <div class=\\"bar3\\" />\\n    </div>\\n  </div>\\n\\n  <div id=\\"mySidenav\\" class=\\"sidenav\\" class:open={navOpen}>\\n    <a href=\\"\\" class=\\"closebtn\\" on:click={handleNav}>&times;</a>\\n    <a href=\\"/\\" on:click={handleNav}>Home</a>\\n    <a href=\\"/about\\" on:click={handleNav}>About</a>\\n    <a href=\\"/work\\" on:click={handleNav}>Work</a>\\n    <!-- <a href=\\"/blog\\" on:click={handleNav}>Blog</a> -->\\n    <!-- <a href=\\"/contact\\" on:click={handleNav}>Contact</a> -->\\n  </div>\\n</div>\\n\\n<style>\\n  .menu {\\n    width: 93%;\\n    margin: 0 auto;\\n    display: flex;\\n    align-items: center;\\n    justify-content: space-between;\\n    margin-top: 0.75rem;\\n  }\\n\\n  .menu img {\\n    display: block;\\n    height: 32px;\\n  }\\n\\n  /* Hamburger Menu icon */\\n  .container {\\n    cursor: pointer;\\n  }\\n\\n  .bar1,\\n  .bar2,\\n  .bar3 {\\n    width: 32px;\\n    height: 3px;\\n    background-color: var(--text-color);\\n    opacity: 85%;\\n    margin: 8px 0;\\n    transition: 0.4s;\\n  }\\n\\n  .change .bar1 {\\n    -webkit-transform: rotate(-45deg) translate(-9px, 6px);\\n    transform: rotate(-45deg) translate(-9px, 6px);\\n  }\\n\\n  .change .bar2 {\\n    opacity: 0;\\n  }\\n\\n  .change .bar3 {\\n    -webkit-transform: rotate(45deg) translate(-8px, -8px);\\n    transform: rotate(45deg) translate(-8px, -8px);\\n  }\\n\\n  /* The side navigation menu */\\n  .sidenav {\\n    height: 100%;\\n    width: 0; /* 0 width - change this with JavaScript */\\n    position: fixed;\\n    z-index: 9;\\n    top: 0;\\n    left: 0;\\n    background-color: var(--primary-color);\\n    opacity: 0.98999;\\n    overflow-x: hidden; /* Disable horizontal scroll */\\n    padding-top: 60px;\\n    transition: 0.5s;\\n  }\\n\\n  /* The navigation menu links */\\n  .sidenav a {\\n    padding: 28px 8px 28px 32px;\\n    text-decoration: none;\\n    font-size: 20px;\\n    color: var(--text-color);\\n    display: block;\\n    transition: 0.3s;\\n    border-bottom: 1px solid var(--secondary-color);\\n  }\\n\\n  .sidenav a:first-child {\\n    padding-top: 17px;\\n  }\\n\\n  .sidenav a:first-child,\\n  .sidenav a:last-child {\\n    border-bottom: none;\\n  }\\n\\n  /* When you mouse over the navigation links, change their color */\\n  .sidenav a:hover {\\n    color: #f1f1f1;\\n    color: var(--accent-color);\\n  }\\n\\n  /* Position and style the close button (top right corner) */\\n  .sidenav .closebtn {\\n    position: absolute;\\n    top: -5px;\\n    right: 25px;\\n    font-size: 36px;\\n    margin-left: 50px;\\n  }\\n\\n  .open {\\n    width: 60%;\\n  }\\n\\n  /* On smaller screens, where height is less than 450px, change the style of the sidenav (less padding and a smaller font size) */\\n  @media (min-width: 768px) {\\n    .container {\\n      display: none;\\n    }\\n\\n    .navigation {\\n      width: 90%;\\n      max-width: 1600px;\\n      margin: auto;\\n      display: flex;\\n      justify-content: space-between;\\n      align-items: center;\\n      position: relative;\\n      height: fit-content;\\n      margin-top: 0.75rem;\\n    }\\n\\n    .menu {\\n      margin: 0;\\n    }\\n\\n    .menu img {\\n      display: block;\\n      height: 36px;\\n    }\\n\\n    .sidenav {\\n      display: flex;\\n      height: 100%;\\n      width: 100%; /* 0 width - change this with JavaScript */\\n      position: static;\\n      background-color: transparent;\\n      padding-top: 0;\\n      transition: 0s;\\n      justify-content: flex-end;\\n    }\\n\\n    .sidenav a {\\n      font-size: 18px;\\n    }\\n\\n    .sidenav a:first-child {\\n      display: none;\\n    }\\n\\n    .sidenav a {\\n      margin: 0;\\n      padding: 0;\\n      padding-left: 2.4rem;\\n    }\\n\\n    .sidenav .closebtn {\\n      position: static;\\n      top: 0;\\n      right: 0;\\n      font-size: 36px;\\n      margin-left: 0;\\n    }\\n  }\\n</style>\\n"],"names":[],"mappings":"AAsCE,KAAK,4BAAC,CAAC,AACL,KAAK,CAAE,GAAG,CACV,MAAM,CAAE,CAAC,CAAC,IAAI,CACd,OAAO,CAAE,IAAI,CACb,WAAW,CAAE,MAAM,CACnB,eAAe,CAAE,aAAa,CAC9B,UAAU,CAAE,OAAO,AACrB,CAAC,AAED,mBAAK,CAAC,GAAG,cAAC,CAAC,AACT,OAAO,CAAE,KAAK,CACd,MAAM,CAAE,IAAI,AACd,CAAC,AAGD,UAAU,4BAAC,CAAC,AACV,MAAM,CAAE,OAAO,AACjB,CAAC,AAED,iCAAK,CACL,iCAAK,CACL,KAAK,4BAAC,CAAC,AACL,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,GAAG,CACX,gBAAgB,CAAE,IAAI,YAAY,CAAC,CACnC,OAAO,CAAE,GAAG,CACZ,MAAM,CAAE,GAAG,CAAC,CAAC,CACb,UAAU,CAAE,IAAI,AAClB,CAAC,AAED,qBAAO,CAAC,KAAK,cAAC,CAAC,AACb,iBAAiB,CAAE,OAAO,MAAM,CAAC,CAAC,UAAU,IAAI,CAAC,CAAC,GAAG,CAAC,CACtD,SAAS,CAAE,OAAO,MAAM,CAAC,CAAC,UAAU,IAAI,CAAC,CAAC,GAAG,CAAC,AAChD,CAAC,AAED,qBAAO,CAAC,KAAK,cAAC,CAAC,AACb,OAAO,CAAE,CAAC,AACZ,CAAC,AAED,qBAAO,CAAC,KAAK,cAAC,CAAC,AACb,iBAAiB,CAAE,OAAO,KAAK,CAAC,CAAC,UAAU,IAAI,CAAC,CAAC,IAAI,CAAC,CACtD,SAAS,CAAE,OAAO,KAAK,CAAC,CAAC,UAAU,IAAI,CAAC,CAAC,IAAI,CAAC,AAChD,CAAC,AAGD,QAAQ,4BAAC,CAAC,AACR,MAAM,CAAE,IAAI,CACZ,KAAK,CAAE,CAAC,CACR,QAAQ,CAAE,KAAK,CACf,OAAO,CAAE,CAAC,CACV,GAAG,CAAE,CAAC,CACN,IAAI,CAAE,CAAC,CACP,gBAAgB,CAAE,IAAI,eAAe,CAAC,CACtC,OAAO,CAAE,OAAO,CAChB,UAAU,CAAE,MAAM,CAClB,WAAW,CAAE,IAAI,CACjB,UAAU,CAAE,IAAI,AAClB,CAAC,AAGD,sBAAQ,CAAC,CAAC,cAAC,CAAC,AACV,OAAO,CAAE,IAAI,CAAC,GAAG,CAAC,IAAI,CAAC,IAAI,CAC3B,eAAe,CAAE,IAAI,CACrB,SAAS,CAAE,IAAI,CACf,KAAK,CAAE,IAAI,YAAY,CAAC,CACxB,OAAO,CAAE,KAAK,CACd,UAAU,CAAE,IAAI,CAChB,aAAa,CAAE,GAAG,CAAC,KAAK,CAAC,IAAI,iBAAiB,CAAC,AACjD,CAAC,AAED,sBAAQ,CAAC,eAAC,YAAY,AAAC,CAAC,AACtB,WAAW,CAAE,IAAI,AACnB,CAAC,AAED,sBAAQ,CAAC,eAAC,YAAY,CACtB,sBAAQ,CAAC,eAAC,WAAW,AAAC,CAAC,AACrB,aAAa,CAAE,IAAI,AACrB,CAAC,AAGD,sBAAQ,CAAC,eAAC,MAAM,AAAC,CAAC,AAChB,KAAK,CAAE,OAAO,CACd,KAAK,CAAE,IAAI,cAAc,CAAC,AAC5B,CAAC,AAGD,sBAAQ,CAAC,SAAS,cAAC,CAAC,AAClB,QAAQ,CAAE,QAAQ,CAClB,GAAG,CAAE,IAAI,CACT,KAAK,CAAE,IAAI,CACX,SAAS,CAAE,IAAI,CACf,WAAW,CAAE,IAAI,AACnB,CAAC,AAED,KAAK,4BAAC,CAAC,AACL,KAAK,CAAE,GAAG,AACZ,CAAC,AAGD,MAAM,AAAC,YAAY,KAAK,CAAC,AAAC,CAAC,AACzB,UAAU,4BAAC,CAAC,AACV,OAAO,CAAE,IAAI,AACf,CAAC,AAED,WAAW,4BAAC,CAAC,AACX,KAAK,CAAE,GAAG,CACV,SAAS,CAAE,MAAM,CACjB,MAAM,CAAE,IAAI,CACZ,OAAO,CAAE,IAAI,CACb,eAAe,CAAE,aAAa,CAC9B,WAAW,CAAE,MAAM,CACnB,QAAQ,CAAE,QAAQ,CAClB,MAAM,CAAE,WAAW,CACnB,UAAU,CAAE,OAAO,AACrB,CAAC,AAED,KAAK,4BAAC,CAAC,AACL,MAAM,CAAE,CAAC,AACX,CAAC,AAED,mBAAK,CAAC,GAAG,cAAC,CAAC,AACT,OAAO,CAAE,KAAK,CACd,MAAM,CAAE,IAAI,AACd,CAAC,AAED,QAAQ,4BAAC,CAAC,AACR,OAAO,CAAE,IAAI,CACb,MAAM,CAAE,IAAI,CACZ,KAAK,CAAE,IAAI,CACX,QAAQ,CAAE,MAAM,CAChB,gBAAgB,CAAE,WAAW,CAC7B,WAAW,CAAE,CAAC,CACd,UAAU,CAAE,EAAE,CACd,eAAe,CAAE,QAAQ,AAC3B,CAAC,AAED,sBAAQ,CAAC,CAAC,cAAC,CAAC,AACV,SAAS,CAAE,IAAI,AACjB,CAAC,AAED,sBAAQ,CAAC,eAAC,YAAY,AAAC,CAAC,AACtB,OAAO,CAAE,IAAI,AACf,CAAC,AAED,sBAAQ,CAAC,CAAC,cAAC,CAAC,AACV,MAAM,CAAE,CAAC,CACT,OAAO,CAAE,CAAC,CACV,YAAY,CAAE,MAAM,AACtB,CAAC,AAED,sBAAQ,CAAC,SAAS,cAAC,CAAC,AAClB,QAAQ,CAAE,MAAM,CAChB,GAAG,CAAE,CAAC,CACN,KAAK,CAAE,CAAC,CACR,SAAS,CAAE,IAAI,CACf,WAAW,CAAE,CAAC,AAChB,CAAC,AACH,CAAC"}`
};
var Canvas = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css$8);
  return `<div class="${"navigation svelte-s77xgt"}"><div class="${"menu svelte-s77xgt"}"><div class="${"logo"}"><a href="${"/"}"><img src="${"img/visign-logo.svg"}" alt="${"visign kenya logo"}" class="${"svelte-s77xgt"}"></a></div>
    <div class="${["container svelte-s77xgt", ""].join(" ").trim()}"><div class="${"bar1 svelte-s77xgt"}"></div>
      <div class="${"bar2 svelte-s77xgt"}"></div>
      <div class="${"bar3 svelte-s77xgt"}"></div></div></div>

  <div id="${"mySidenav"}" class="${["sidenav svelte-s77xgt", ""].join(" ").trim()}"><a href="${""}" class="${"closebtn svelte-s77xgt"}">\xD7</a>
    <a href="${"/"}" class="${"svelte-s77xgt"}">Home</a>
    <a href="${"/about"}" class="${"svelte-s77xgt"}">About</a>
    <a href="${"/work"}" class="${"svelte-s77xgt"}">Work</a>
    
    </div>
</div>`;
});
var css$7 = {
  code: "main.svelte-1xvpp4v.svelte-1xvpp4v{flex:1;display:flex;flex-direction:column;width:92%;margin:0 auto;box-sizing:border-box}footer.svelte-1xvpp4v.svelte-1xvpp4v{display:flex;flex-direction:column;justify-content:center;align-items:center;padding-top:4rem}footer.svelte-1xvpp4v a.svelte-1xvpp4v{font-weight:bold;text-decoration:none}footer.svelte-1xvpp4v p.svelte-1xvpp4v{width:92%;max-width:1024px;margin:0 auto}.social-icons.svelte-1xvpp4v.svelte-1xvpp4v{display:flex;margin:2.75rem 0 2.5rem 0;gap:1rem}.social-icons.svelte-1xvpp4v img.svelte-1xvpp4v{display:block;width:100%;max-width:28px}@media(min-width: 480px){}",
  map: `{"version":3,"file":"__layout.svelte","sources":["__layout.svelte"],"sourcesContent":["<script>\\n  import Canvas from '$lib/header/Canvas.svelte'\\n  import '../app.css'\\n<\/script>\\n\\n<Canvas />\\n\\n<main>\\n  <slot />\\n</main>\\n\\n<footer>\\n  <p>\\n    Thank you for visiting. <a href=\\"mailto:dkibui@visign.co.ke\\">\\n      Send us an email\\n    </a>\\n    to see how we can help.\\n  </p>\\n  <div class=\\"social-icons\\">\\n    <a href=\\"https://www.behance.net\\">\\n      <img src=\\"img/social/behance.png\\" alt=\\"behance logo\\" />\\n    </a>\\n    <a href=\\"https://www.instagram.com\\">\\n      <img src=\\"img/social/instagram.png\\" alt=\\"instagram logo\\" />\\n    </a>\\n    <a href=\\"https://www.twitter.com\\">\\n      <img src=\\"img/social/twitter.png\\" alt=\\"twitter logo\\" />\\n    </a>\\n  </div>\\n</footer>\\n\\n<style>\\n  main {\\n    flex: 1;\\n    display: flex;\\n    flex-direction: column;\\n    width: 92%;\\n    margin: 0 auto;\\n    box-sizing: border-box;\\n  }\\n\\n  footer {\\n    display: flex;\\n    flex-direction: column;\\n    justify-content: center;\\n    align-items: center;\\n    padding-top: 4rem;\\n  }\\n\\n  footer a {\\n    font-weight: bold;\\n    text-decoration: none;\\n  }\\n\\n  footer p {\\n    width: 92%;\\n    max-width: 1024px;\\n    margin: 0 auto;\\n  }\\n\\n  .social-icons {\\n    display: flex;\\n    margin: 2.75rem 0 2.5rem 0;\\n    gap: 1rem;\\n  }\\n\\n  .social-icons img {\\n    display: block;\\n    width: 100%;\\n    max-width: 28px;\\n  }\\n\\n  @media (min-width: 480px) {\\n    /* footer {\\n      padding: 40px 0;\\n    } */\\n  }\\n</style>\\n"],"names":[],"mappings":"AAgCE,IAAI,8BAAC,CAAC,AACJ,IAAI,CAAE,CAAC,CACP,OAAO,CAAE,IAAI,CACb,cAAc,CAAE,MAAM,CACtB,KAAK,CAAE,GAAG,CACV,MAAM,CAAE,CAAC,CAAC,IAAI,CACd,UAAU,CAAE,UAAU,AACxB,CAAC,AAED,MAAM,8BAAC,CAAC,AACN,OAAO,CAAE,IAAI,CACb,cAAc,CAAE,MAAM,CACtB,eAAe,CAAE,MAAM,CACvB,WAAW,CAAE,MAAM,CACnB,WAAW,CAAE,IAAI,AACnB,CAAC,AAED,qBAAM,CAAC,CAAC,eAAC,CAAC,AACR,WAAW,CAAE,IAAI,CACjB,eAAe,CAAE,IAAI,AACvB,CAAC,AAED,qBAAM,CAAC,CAAC,eAAC,CAAC,AACR,KAAK,CAAE,GAAG,CACV,SAAS,CAAE,MAAM,CACjB,MAAM,CAAE,CAAC,CAAC,IAAI,AAChB,CAAC,AAED,aAAa,8BAAC,CAAC,AACb,OAAO,CAAE,IAAI,CACb,MAAM,CAAE,OAAO,CAAC,CAAC,CAAC,MAAM,CAAC,CAAC,CAC1B,GAAG,CAAE,IAAI,AACX,CAAC,AAED,4BAAa,CAAC,GAAG,eAAC,CAAC,AACjB,OAAO,CAAE,KAAK,CACd,KAAK,CAAE,IAAI,CACX,SAAS,CAAE,IAAI,AACjB,CAAC,AAED,MAAM,AAAC,YAAY,KAAK,CAAC,AAAC,CAAC,AAI3B,CAAC"}`
};
var _layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css$7);
  return `${validate_component(Canvas, "Canvas").$$render($$result, {}, {}, {})}

<main class="${"svelte-1xvpp4v"}">${slots.default ? slots.default({}) : ``}</main>

<footer class="${"svelte-1xvpp4v"}"><p class="${"svelte-1xvpp4v"}">Thank you for visiting. <a href="${"mailto:dkibui@visign.co.ke"}" class="${"svelte-1xvpp4v"}">Send us an email
    </a>
    to see how we can help.
  </p>
  <div class="${"social-icons svelte-1xvpp4v"}"><a href="${"https://www.behance.net"}" class="${"svelte-1xvpp4v"}"><img src="${"img/social/behance.png"}" alt="${"behance logo"}" class="${"svelte-1xvpp4v"}"></a>
    <a href="${"https://www.instagram.com"}" class="${"svelte-1xvpp4v"}"><img src="${"img/social/instagram.png"}" alt="${"instagram logo"}" class="${"svelte-1xvpp4v"}"></a>
    <a href="${"https://www.twitter.com"}" class="${"svelte-1xvpp4v"}"><img src="${"img/social/twitter.png"}" alt="${"twitter logo"}" class="${"svelte-1xvpp4v"}"></a></div>
</footer>`;
});
...
<div class="${"content-500 svelte-myg9zw"}"><h1 class="${"svelte-myg9zw"}">Our business is to make yours look good</h1>
  <p>We provide brand centred graphic design and web development services to SMEs
    and corporates in Nairobi
  </p></div>

<div class="${"content svelte-myg9zw"}">${validate_component(Swiper, "Swiper").$$render($$result, {
    slidesPerView: 3,
    spaceBetween: 10,
    slidesPerGroup: 1,
    mousewheel: false,
    ...
    default: () => `${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/recent/8.jpg"}" alt="${""}" class="${"svelte-myg9zw"}">`
    })}
    ${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/recent/2.jpg"}" alt="${""}" class="${"svelte-myg9zw"}">`
    })}
    ${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/recent/1.jpg"}" alt="${""}" class="${"svelte-myg9zw"}">`
    })}
    ${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/recent/9.jpg"}" alt="${""}" class="${"svelte-myg9zw"}">`
    })}
    ${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/recent/5.jpg"}" alt="${""}" class="${"svelte-myg9zw"}">`
    })}
    ${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/recent/6.jpg"}" alt="${""}" class="${"svelte-myg9zw"}">`
    })}
    ${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/recent/liberte.jpg"}" alt="${""}" class="${"svelte-myg9zw"}">`
    })}`
  })}</div>

<h2 class="${"svelte-myg9zw"}">Our services</h2>

<div class="${"accordion svelte-myg9zw"}">${each$1(Object.entries(data), (entry) => `${validate_component(Accordion, "Accordion").$$render($$result, { entry }, {}, {})}`)}</div>



<h2 class="${"svelte-myg9zw"}">Our clients</h2>

<div class="${"logos svelte-myg9zw"}">${validate_component(Swiper, "Swiper").$$render($$result, {
    slidesPerView: 3,
    spaceBetween: 20,
    slidesPerGroup: 1,
    mousewheel: false,
    ...
    default: () => `${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/logos/amsco.png"}" alt="${"amsco logo"}" class="${"svelte-myg9zw"}">`
    })}
    
    ${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/logos/anchor.png"}" alt="${"Anchor builders logo"}" class="${"svelte-myg9zw"}">`
    })}
    ${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/logos/strathmore.png"}" alt="${"Strathmore University logo"}" class="${"svelte-myg9zw"}">`
    })}
    ${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/logos/eaglehr.png"}" alt="${"Eaglehr kenya logo"}" class="${"svelte-myg9zw"}">`
    })}
    ${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/logos/absa.png"}" alt="${"absa bank logo"}" class="${"svelte-myg9zw"}">`
    })}
    ${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/logos/farmhouse.png"}" alt="${"farmhouse sacco logo"}" class="${"svelte-myg9zw"}">`
    })}`
  })}
</div>`;
});
...
<div class="${"content-500 svelte-16pl8vx"}"><h1>About Us</h1>
  ...
  <p>As we have grown so has our service offering. Now we also offer brand
    development, website development and branding of marketing supplies.
  </p></div>
...
<div class="${"content-500 svelte-7o8txp"}"><h1>Anchor homes branding project.</h1>
  ...
  <p>We have implemented this based on the principle of simplicity and
    recognition.
  </p></div>
