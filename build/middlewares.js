...
function init(settings = default_settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: assets + "/_app/start-ac0001b3.js",
      css: [assets + "/_app/assets/start-61d1577b.css"],
      js: [assets + "/_app/start-ac0001b3.js", assets + "/_app/chunks/vendor-336043de.js"]
    },
    fetched: void 0,
    floc: false,
...
var metadata_lookup = { "src/routes/__layout.svelte": { "entry": "pages/__layout.svelte-28db4490.js", "css": ["assets/pages/__layout.svelte-e76e1bdb.css"], "js": ["pages/__layout.svelte-28db4490.js", "chunks/vendor-336043de.js"], "styles": [] }, ".svelte-kit/build/components/error.svelte": { "entry": "error.svelte-086a6be9.js", "css": [], "js": ["error.svelte-086a6be9.js", "chunks/vendor-336043de.js"], "styles": [] }, "src/routes/index.svelte": { "entry": "pages/index.svelte-ce8796d1.js", "css": ["assets/pages/index.svelte-a7c52bb8.css", "assets/pagination.min-4d3a60e0.css", "assets/Recent-ad7143e3.css"], "js": ["pages/index.svelte-ce8796d1.js", "chunks/vendor-336043de.js", "chunks/Recent-8997acb8.js"], "styles": [] }, "src/routes/collapsible.svelte": { "entry": "pages/collapsible.svelte-1a568d6c.js", "css": [], "js": ["pages/collapsible.svelte-1a568d6c.js", "chunks/vendor-336043de.js"], "styles": [] }, "src/routes/about.svelte": { "entry": "pages/about.svelte-789ecf34.js", "css": ["assets/pages/about.svelte-de8cddf4.css", "assets/pagination.min-4d3a60e0.css"], "js": ["pages/about.svelte-789ecf34.js", "chunks/vendor-336043de.js"], "styles": [] }, "src/routes/menu.svelte": { "entry": "pages/menu.svelte-9774df1f.js", "css": [], "js": ["pages/menu.svelte-9774df1f.js", "chunks/vendor-336043de.js"], "styles": [] }, "src/routes/test.svelte": { "entry": "pages/test.svelte-5da8fbd4.js", "css": ["assets/pages/test.svelte-4d6faebe.css", "assets/Recent-ad7143e3.css"], "js": ["pages/test.svelte-5da8fbd4.js", "chunks/vendor-336043de.js", "chunks/Recent-8997acb8.js"], "styles": [] }, "src/routes/work.svelte": { "entry": "pages/work.svelte-b29bf66f.js", "css": ["assets/pages/work.svelte-b11f963d.css"], "js": ["pages/work.svelte-b29bf66f.js", "chunks/vendor-336043de.js"], "styles": [] } };
...
var css$8 = {
  code: "article.svelte-91v9jd.svelte-91v9jd{padding:0.875rem;max-width:500px;background-color:white;border-radius:8px;display:flex;flex-direction:column;gap:0.85rem;box-shadow:rgba(33, 35, 38, 0.1) 0px 14px 10px -10px}article.svelte-91v9jd div.svelte-91v9jd:first-child{margin-bottom:1rem}.img.svelte-91v9jd.svelte-91v9jd{border-bottom-left-radius:16px;border-bottom-right-radius:16px;overflow:hidden;box-shadow:rgba(9, 30, 66, 0.25) 0px 4px 8px -2px,\r\n      rgba(9, 30, 66, 0.08) 0px 0px 0px 1px}@media(min-width: 768px){article.svelte-91v9jd.svelte-91v9jd{gap:0.75rem}}",
  map: '{"version":3,"file":"RecentCard.svelte","sources":["RecentCard.svelte"],"sourcesContent":["<script>\\r\\n<\/script>\\r\\n\\r\\n<article>\\r\\n  <div class=\\"img\\">\\r\\n    <slot name=\\"image\\" />\\r\\n  </div>\\r\\n  <div>\\r\\n    <slot name=\\"description\\" />\\r\\n  </div>\\r\\n  <div>\\r\\n    <slot name=\\"link\\" />\\r\\n  </div>\\r\\n</article>\\r\\n\\r\\n<style>\\r\\n  article {\\r\\n    padding: 0.875rem;\\r\\n    max-width: 500px;\\r\\n    background-color: white;\\r\\n    border-radius: 8px;\\r\\n    display: flex;\\r\\n    flex-direction: column;\\r\\n    gap: 0.85rem;\\r\\n    box-shadow: rgba(33, 35, 38, 0.1) 0px 14px 10px -10px;\\r\\n  }\\r\\n\\r\\n  article div:first-child {\\r\\n    margin-bottom: 1rem;\\r\\n  }\\r\\n\\r\\n  .img {\\r\\n    border-bottom-left-radius: 16px;\\r\\n    border-bottom-right-radius: 16px;\\r\\n    overflow: hidden;\\r\\n    box-shadow: rgba(9, 30, 66, 0.25) 0px 4px 8px -2px,\\r\\n      rgba(9, 30, 66, 0.08) 0px 0px 0px 1px;\\r\\n    /* -webkit-box-shadow: 0px 10px 10px -10px rgba(33, 35, 38, 0.1);\\r\\n    -moz-box-shadow: 0px 10px 10px -10px rgba(33, 35, 38, 0.1); */\\r\\n  }\\r\\n\\r\\n  @media (min-width: 768px) {\\r\\n    article {\\r\\n      gap: 0.75rem;\\r\\n    }\\r\\n  }\\r\\n</style>\\r\\n"],"names":[],"mappings":"AAgBE,OAAO,4BAAC,CAAC,AACP,OAAO,CAAE,QAAQ,CACjB,SAAS,CAAE,KAAK,CAChB,gBAAgB,CAAE,KAAK,CACvB,aAAa,CAAE,GAAG,CAClB,OAAO,CAAE,IAAI,CACb,cAAc,CAAE,MAAM,CACtB,GAAG,CAAE,OAAO,CACZ,UAAU,CAAE,KAAK,EAAE,CAAC,CAAC,EAAE,CAAC,CAAC,EAAE,CAAC,CAAC,GAAG,CAAC,CAAC,GAAG,CAAC,IAAI,CAAC,IAAI,CAAC,KAAK,AACvD,CAAC,AAED,qBAAO,CAAC,iBAAG,YAAY,AAAC,CAAC,AACvB,aAAa,CAAE,IAAI,AACrB,CAAC,AAED,IAAI,4BAAC,CAAC,AACJ,yBAAyB,CAAE,IAAI,CAC/B,0BAA0B,CAAE,IAAI,CAChC,QAAQ,CAAE,MAAM,CAChB,UAAU,CAAE,KAAK,CAAC,CAAC,CAAC,EAAE,CAAC,CAAC,EAAE,CAAC,CAAC,IAAI,CAAC,CAAC,GAAG,CAAC,GAAG,CAAC,GAAG,CAAC,IAAI,CAAC;MACjD,KAAK,CAAC,CAAC,CAAC,EAAE,CAAC,CAAC,EAAE,CAAC,CAAC,IAAI,CAAC,CAAC,GAAG,CAAC,GAAG,CAAC,GAAG,CAAC,GAAG,AAGzC,CAAC,AAED,MAAM,AAAC,YAAY,KAAK,CAAC,AAAC,CAAC,AACzB,OAAO,4BAAC,CAAC,AACP,GAAG,CAAE,OAAO,AACd,CAAC,AACH,CAAC"}'
};
var RecentCard = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css$8);
  return `<article class="${"svelte-91v9jd"}"><div class="${"img svelte-91v9jd"}">${slots.image ? slots.image({}) : ``}</div>
  <div class="${"svelte-91v9jd"}">${slots.description ? slots.description({}) : ``}</div>
  <div class="${"svelte-91v9jd"}">${slots.link ? slots.link({}) : ``}</div>
</article>`;
});
var css$7 = {
...
<div class="${"content-500 svelte-12052y5"}"><h1 class="${"svelte-12052y5"}">Our business is making yours look good.</h1>
  <p class="${"svelte-12052y5"}">We provide brand centred graphic design and web development services to SMEs
    and corporates in Nairobi.
  </p></div>

<div class="${"content svelte-12052y5"}">${validate_component(Swiper, "Swiper").$$render($$result, {
    slidesPerView: 3,
    spaceBetween: 10,
    slidesPerGroup: 1,
    mousewheel: false,
    ...
    default: () => `${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/recent/8.jpg"}" alt="${""}" class="${"svelte-12052y5"}">`
    })}
    ${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/recent/2.jpg"}" alt="${""}" class="${"svelte-12052y5"}">`
    })}
    ${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/recent/11.jpg"}" alt="${""}" class="${"svelte-12052y5"}">`
    })}
    ${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/recent/9.jpg"}" alt="${""}" class="${"svelte-12052y5"}">`
    })}
    ${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/recent/55.jpg"}" alt="${""}" class="${"svelte-12052y5"}">`
    })}
    ${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/recent/6.jpg"}" alt="${""}" class="${"svelte-12052y5"}">`
    })}
    ${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/recent/liberte.jpg"}" alt="${""}" class="${"svelte-12052y5"}">`
    })}`
  })}</div>

<div class="${"services svelte-12052y5"}"><h2 class="${"svelte-12052y5"}">Our services</h2>
  <div class="${"accordion svelte-12052y5"}">${each$1(Object.entries(data), (entry) => `${validate_component(Accordion, "Accordion").$$render($$result, { entry }, {}, {})}`)}</div></div>

<div class="${"recent svelte-12052y5"}"><h2 class="${"svelte-12052y5"}">Recent projects</h2>
  <p class="${"recent__text svelte-12052y5"}">We handle many full brand development projects. Below we showcase the ones
    we completed recently
  </p></div>

<div class="${"four-way-grid svelte-12052y5"}">${validate_component(Recent, "Recent").$$render($$result, {}, {}, {})}</div>

<div class="${"clients svelte-12052y5"}"><h2 class="${"svelte-12052y5"}">Our clients</h2>
  <p class="${"svelte-12052y5"}">We work with companies of all sizes. Start-ups, SMES or corporates.
    Regardless of your size our goal is always the same, do work that helps you
    stand out in the market place.
  </p></div>

<div class="${"logos svelte-12052y5"}">${validate_component(Swiper, "Swiper").$$render($$result, {
    slidesPerView: 3,
    spaceBetween: 20,
    slidesPerGroup: 1,
    mousewheel: false,
    ...
    default: () => `${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/logos/amsco.png"}" alt="${"amsco logo"}" class="${"svelte-12052y5"}">`
    })}
    
    ${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/logos/anchor.png"}" alt="${"Anchor builders logo"}" class="${"svelte-12052y5"}">`
    })}
    ${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/logos/strathmore.png"}" alt="${"Strathmore University logo"}" class="${"svelte-12052y5"}">`
    })}
    ${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/logos/eaglehr.png"}" alt="${"Eaglehr kenya logo"}" class="${"svelte-12052y5"}">`
    })}
    ${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/logos/absa.png"}" alt="${"absa bank logo"}" class="${"svelte-12052y5"}">`
    })}
    ${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/logos/farmhouse.png"}" alt="${"farmhouse sacco logo"}" class="${"svelte-12052y5"}">`
    })}`
  })}
</div>`;
});
