...
function init(settings = default_settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: assets + "/_app/start-0063d082.js",
      css: [assets + "/_app/assets/start-61d1577b.css"],
      js: [assets + "/_app/start-0063d082.js", assets + "/_app/chunks/vendor-7aaed8c5.js"]
    },
    fetched: void 0,
    floc: false,
...
var Accordion = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="${"btn svelte-tijkl9"}"${add_attribute("aria-expanded", isOpen, 0)}><p class="${"svelte-tijkl9"}">${escape(entry[0])}</p>
  <div class="${"svg-div svelte-tijkl9"}"><svg class="${"svg svelte-tijkl9"}" height="${"12"}" width="${"12"}"><line x1="${"0"}" y1="${"6"}" x2="${"12"}" y2="${"6"}"></line><line x1="${"6"}" y1="${"12"}" x2="${"6"}" y2="${"0"}"></line></svg></div></div>
