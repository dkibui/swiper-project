...
function init(settings = default_settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: assets + "/_app/start-811a906e.js",
      css: [assets + "/_app/assets/start-61d1577b.css"],
      js: [assets + "/_app/start-811a906e.js", assets + "/_app/chunks/vendor-5b13c1bf.js"]
    },
    fetched: void 0,
    floc: false,
...
var css$a = {
  code: "p.svelte-10ieqha.svelte-10ieqha{font-size:0.97rem;padding:0.75em;color:var(--text-color);text-align:left;line-height:1.6}p.svelte-10ieqha.svelte-10ieqha:last-child{margin-bottom:1rem}.btn.svelte-10ieqha.svelte-10ieqha{display:flex;align-items:center;border-radius:3px;background:var(--darker);color:var(--text-color);font-size:17px;cursor:pointer;margin:0.25rem 0;padding-bottom:0.5em;padding-top:0.5em;padding-left:0.5em;text-align:left}.btn.svelte-10ieqha p.svelte-10ieqha{font-size:1.0125em;font-weight:500;margin:0;margin-left:0.35em;padding:0}svg.svelte-10ieqha.svelte-10ieqha{transition:transform 0.4s ease-in-out}[aria-expanded='true'].svelte-10ieqha svg.svelte-10ieqha{transform:rotate(0.25turn)}",
  map: `{"version":3,"file":"Accordion.svelte","sources":["Accordion.svelte"],"sourcesContent":["<script>\\r\\n  import { slide } from 'svelte/transition'\\r\\n  import { sineInOut, quadInOut } from 'svelte/easing'\\r\\n  export let entry\\r\\n  let isOpen = false\\r\\n  const toggle = () => (isOpen = !isOpen)\\r\\n<\/script>\\r\\n\\r\\n<div class=\\"btn\\" on:click={toggle} aria-expanded={isOpen}>\\r\\n  <svg\\r\\n    style=\\"tran\\"\\r\\n    width=\\"20\\"\\r\\n    height=\\"20\\"\\r\\n    fill=\\"none\\"\\r\\n    stroke-linecap=\\"round\\"\\r\\n    stroke-linejoin=\\"round\\"\\r\\n    stroke-width=\\"2\\"\\r\\n    viewBox=\\"0 0 24 24\\"\\r\\n    stroke=\\"currentColor\\"><path d=\\"M9 5l7 7-7 7\\" /></svg\\r\\n  >\\r\\n  <p>{entry[0]}</p>\\r\\n</div>\\r\\n\\r\\n{#if isOpen}\\r\\n  <div transition:slide={{ duration: 250, easing: quadInOut }}>\\r\\n    {#each entry[1] as item}\\r\\n      <p>{item}</p>\\r\\n    {/each}\\r\\n  </div>\\r\\n{/if}\\r\\n\\r\\n<style>\\r\\n  p {\\r\\n    font-size: 0.97rem;\\r\\n    padding: 0.75em;\\r\\n    color: var(--text-color);\\r\\n    text-align: left;\\r\\n    line-height: 1.6;\\r\\n  }\\r\\n\\r\\n  p:last-child {\\r\\n    margin-bottom: 1rem;\\r\\n  }\\r\\n\\r\\n  .btn {\\r\\n    display: flex;\\r\\n    align-items: center;\\r\\n    border-radius: 3px;\\r\\n    background: var(--darker);\\r\\n    color: var(--text-color);\\r\\n    font-size: 17px;\\r\\n    cursor: pointer;\\r\\n    margin: 0.25rem 0;\\r\\n    padding-bottom: 0.5em;\\r\\n    padding-top: 0.5em;\\r\\n    padding-left: 0.5em;\\r\\n    text-align: left;\\r\\n  }\\r\\n\\r\\n  .btn p {\\r\\n    font-size: 1.0125em;\\r\\n    font-weight: 500;\\r\\n    margin: 0;\\r\\n    margin-left: 0.35em;\\r\\n    padding: 0;\\r\\n  }\\r\\n\\r\\n  svg {\\r\\n    transition: transform 0.4s ease-in-out;\\r\\n  }\\r\\n\\r\\n  [aria-expanded='true'] svg {\\r\\n    transform: rotate(0.25turn);\\r\\n  }\\r\\n</style>\\r\\n"],"names":[],"mappings":"AAgCE,CAAC,8BAAC,CAAC,AACD,SAAS,CAAE,OAAO,CAClB,OAAO,CAAE,MAAM,CACf,KAAK,CAAE,IAAI,YAAY,CAAC,CACxB,UAAU,CAAE,IAAI,CAChB,WAAW,CAAE,GAAG,AAClB,CAAC,AAED,+BAAC,WAAW,AAAC,CAAC,AACZ,aAAa,CAAE,IAAI,AACrB,CAAC,AAED,IAAI,8BAAC,CAAC,AACJ,OAAO,CAAE,IAAI,CACb,WAAW,CAAE,MAAM,CACnB,aAAa,CAAE,GAAG,CAClB,UAAU,CAAE,IAAI,QAAQ,CAAC,CACzB,KAAK,CAAE,IAAI,YAAY,CAAC,CACxB,SAAS,CAAE,IAAI,CACf,MAAM,CAAE,OAAO,CACf,MAAM,CAAE,OAAO,CAAC,CAAC,CACjB,cAAc,CAAE,KAAK,CACrB,WAAW,CAAE,KAAK,CAClB,YAAY,CAAE,KAAK,CACnB,UAAU,CAAE,IAAI,AAClB,CAAC,AAED,mBAAI,CAAC,CAAC,eAAC,CAAC,AACN,SAAS,CAAE,QAAQ,CACnB,WAAW,CAAE,GAAG,CAChB,MAAM,CAAE,CAAC,CACT,WAAW,CAAE,MAAM,CACnB,OAAO,CAAE,CAAC,AACZ,CAAC,AAED,GAAG,8BAAC,CAAC,AACH,UAAU,CAAE,SAAS,CAAC,IAAI,CAAC,WAAW,AACxC,CAAC,AAED,CAAC,aAAa,CAAC,MAAM,gBAAC,CAAC,GAAG,eAAC,CAAC,AAC1B,SAAS,CAAE,OAAO,QAAQ,CAAC,AAC7B,CAAC"}`
};
var Accordion = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="${"btn svelte-10ieqha"}"${add_attribute("aria-expanded", isOpen, 0)}><svg style="${"tran"}" width="${"20"}" height="${"20"}" fill="${"none"}" stroke-linecap="${"round"}" stroke-linejoin="${"round"}" stroke-width="${"2"}" viewBox="${"0 0 24 24"}" stroke="${"currentColor"}" class="${"svelte-10ieqha"}"><path d="${"M9 5l7 7-7 7"}"></path></svg>
  <p class="${"svelte-10ieqha"}">${escape(entry[0])}</p></div>
