...
function init(settings = default_settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: assets + "/_app/start-0af647b7.js",
      css: [assets + "/_app/assets/start-61d1577b.css"],
      js: [assets + "/_app/start-0af647b7.js", assets + "/_app/chunks/vendor-336043de.js"]
    },
    fetched: void 0,
    floc: false,
...
var metadata_lookup = { "src/routes/__layout.svelte": { "entry": "pages/__layout.svelte-28db4490.js", "css": ["assets/pages/__layout.svelte-e76e1bdb.css"], "js": ["pages/__layout.svelte-28db4490.js", "chunks/vendor-336043de.js"], "styles": [] }, ".svelte-kit/build/components/error.svelte": { "entry": "error.svelte-086a6be9.js", "css": [], "js": ["error.svelte-086a6be9.js", "chunks/vendor-336043de.js"], "styles": [] }, "src/routes/index.svelte": { "entry": "pages/index.svelte-9f340f4e.js", "css": ["assets/pages/index.svelte-60b78428.css", "assets/pagination.min-4d3a60e0.css", "assets/Recent-f4f54264.css"], "js": ["pages/index.svelte-9f340f4e.js", "chunks/vendor-336043de.js", "chunks/Recent-c829ade8.js"], "styles": [] }, "src/routes/collapsible.svelte": { "entry": "pages/collapsible.svelte-1a568d6c.js", "css": [], "js": ["pages/collapsible.svelte-1a568d6c.js", "chunks/vendor-336043de.js"], "styles": [] }, "src/routes/about.svelte": { "entry": "pages/about.svelte-789ecf34.js", "css": ["assets/pages/about.svelte-de8cddf4.css", "assets/pagination.min-4d3a60e0.css"], "js": ["pages/about.svelte-789ecf34.js", "chunks/vendor-336043de.js"], "styles": [] }, "src/routes/menu.svelte": { "entry": "pages/menu.svelte-9774df1f.js", "css": [], "js": ["pages/menu.svelte-9774df1f.js", "chunks/vendor-336043de.js"], "styles": [] }, "src/routes/test.svelte": { "entry": "pages/test.svelte-39c43ade.js", "css": ["assets/pages/test.svelte-4d6faebe.css", "assets/Recent-f4f54264.css"], "js": ["pages/test.svelte-39c43ade.js", "chunks/vendor-336043de.js", "chunks/Recent-c829ade8.js"], "styles": [] }, "src/routes/work.svelte": { "entry": "pages/work.svelte-d15129e4.js", "css": ["assets/pages/work.svelte-a3b0a6d6.css"], "js": ["pages/work.svelte-d15129e4.js", "chunks/vendor-336043de.js"], "styles": [] } };
...
var css$b = {
  code: "main.svelte-ot4zu5.svelte-ot4zu5{flex:1;display:flex;flex-direction:column;width:92%;margin:0 auto;box-sizing:border-box}footer.svelte-ot4zu5.svelte-ot4zu5{display:flex;flex-direction:column;justify-content:center;align-items:center;margin-top:var(--top-margin-mobile)}footer.svelte-ot4zu5 a.svelte-ot4zu5{font-weight:bold;text-decoration:none}footer.svelte-ot4zu5 p.svelte-ot4zu5{width:92%;max-width:1024px;margin:0 auto}.social-icons.svelte-ot4zu5.svelte-ot4zu5{display:grid;grid-template-columns:repeat(3, 1fr);margin-top:2.54rem;margin-bottom:1.5rem;gap:1rem}.social-icons.svelte-ot4zu5 img.svelte-ot4zu5{display:block;width:100%;max-width:28px}@media(min-width: 768px){footer.svelte-ot4zu5.svelte-ot4zu5{padding-top:var(--column-margin-top)}}",
...
<main class="${"svelte-ot4zu5"}">${slots.default ? slots.default({}) : ``}</main>

<footer class="${"svelte-ot4zu5"}"><p class="${"svelte-ot4zu5"}">Thank you for visiting. <a href="${"mailto:dkibui@visign.co.ke"}" class="${"svelte-ot4zu5"}">Send us an email
    </a>
    to see how we can help.
  </p>
  <div class="${"social-icons svelte-ot4zu5"}"><a href="${"https://www.behance.net"}" class="${"svelte-ot4zu5"}"><img src="${"img/social/behance.png"}" alt="${"behance logo"}" class="${"svelte-ot4zu5"}"></a>
    <a href="${"https://www.instagram.com"}" class="${"svelte-ot4zu5"}"><img src="${"img/social/instagram.png"}" alt="${"instagram logo"}" class="${"svelte-ot4zu5"}"></a>
    <a href="${"https://www.twitter.com"}" class="${"svelte-ot4zu5"}"><img src="${"img/social/twitter.png"}" alt="${"twitter logo"}" class="${"svelte-ot4zu5"}"></a></div>
</footer>`;
});
...
<div class="${"width single-img svelte-10j5ntv"}"><img src="${"img/recent/calendar2.jpg"}" alt="${"anchor one"}" class="${"svelte-10j5ntv"}">
</div>`;
});
