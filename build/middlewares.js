...
function init(settings = default_settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: assets + "/_app/start-f11f0502.js",
      css: [assets + "/_app/assets/start-61d1577b.css"],
      js: [assets + "/_app/start-f11f0502.js", assets + "/_app/chunks/vendor-336043de.js"]
    },
    fetched: void 0,
    floc: false,
...
var metadata_lookup = { "src/routes/__layout.svelte": { "entry": "pages/__layout.svelte-3c1c5cf8.js", "css": ["assets/pages/__layout.svelte-f6a45e02.css"], "js": ["pages/__layout.svelte-3c1c5cf8.js", "chunks/vendor-336043de.js"], "styles": [] }, ".svelte-kit/build/components/error.svelte": { "entry": "error.svelte-086a6be9.js", "css": [], "js": ["error.svelte-086a6be9.js", "chunks/vendor-336043de.js"], "styles": [] }, "src/routes/index.svelte": { "entry": "pages/index.svelte-de1d4b3f.js", "css": ["assets/pages/index.svelte-45ee25ca.css", "assets/pagination.min-4d3a60e0.css", "assets/Recent-970365c5.css"], "js": ["pages/index.svelte-de1d4b3f.js", "chunks/vendor-336043de.js", "chunks/Recent-9482cfb7.js"], "styles": [] }, "src/routes/collapsible.svelte": { "entry": "pages/collapsible.svelte-1a568d6c.js", "css": [], "js": ["pages/collapsible.svelte-1a568d6c.js", "chunks/vendor-336043de.js"], "styles": [] }, "src/routes/about.svelte": { "entry": "pages/about.svelte-789ecf34.js", "css": ["assets/pages/about.svelte-de8cddf4.css", "assets/pagination.min-4d3a60e0.css"], "js": ["pages/about.svelte-789ecf34.js", "chunks/vendor-336043de.js"], "styles": [] }, "src/routes/menu.svelte": { "entry": "pages/menu.svelte-9774df1f.js", "css": [], "js": ["pages/menu.svelte-9774df1f.js", "chunks/vendor-336043de.js"], "styles": [] }, "src/routes/test.svelte": { "entry": "pages/test.svelte-300edec0.js", "css": ["assets/pages/test.svelte-4d6faebe.css", "assets/Recent-970365c5.css"], "js": ["pages/test.svelte-300edec0.js", "chunks/vendor-336043de.js", "chunks/Recent-9482cfb7.js"], "styles": [] }, "src/routes/work.svelte": { "entry": "pages/work.svelte-b29bf66f.js", "css": ["assets/pages/work.svelte-b11f963d.css"], "js": ["pages/work.svelte-b29bf66f.js", "chunks/vendor-336043de.js"], "styles": [] } };
...
var css$b = {
  code: "main.svelte-1fndun0.svelte-1fndun0{flex:1;display:flex;flex-direction:column;width:92%;margin:0 auto;box-sizing:border-box}footer.svelte-1fndun0.svelte-1fndun0{display:flex;flex-direction:column;justify-content:center;align-items:center;margin-top:var(--top-margin-mobile)}footer.svelte-1fndun0 a.svelte-1fndun0{font-weight:bold;text-decoration:none}footer.svelte-1fndun0 p.svelte-1fndun0{width:92%;max-width:1024px;margin:0 auto}.social-icons.svelte-1fndun0.svelte-1fndun0{display:grid;grid-template-columns:repeat(3, 1fr);margin-top:2.875rem;margin-bottom:1.5rem;gap:1rem}.social-icons.svelte-1fndun0 img.svelte-1fndun0{display:block;width:100%;max-width:28px}@media(min-width: 768px){footer.svelte-1fndun0.svelte-1fndun0{padding-top:var(--column-margin-top)}}",
  map: `{"version":3,"file":"__layout.svelte","sources":["__layout.svelte"],"sourcesContent":["<script>\\n  import Canvas from '$lib/header/Canvas.svelte'\\n  import '../app.css'\\n<\/script>\\n\\n<Canvas />\\n\\n<main>\\n  <slot />\\n</main>\\n\\n<footer>\\n  <p>\\n    Thank you for visiting. <a href=\\"mailto:dkibui@visign.co.ke\\">\\n      Send us an email\\n    </a>\\n    to see how we can help.\\n  </p>\\n  <div class=\\"social-icons\\">\\n    <a href=\\"https://www.behance.net\\">\\n      <img src=\\"img/social/behance.png\\" alt=\\"behance logo\\" />\\n    </a>\\n    <a href=\\"https://www.instagram.com\\">\\n      <img src=\\"img/social/instagram.png\\" alt=\\"instagram logo\\" />\\n    </a>\\n    <a href=\\"https://www.twitter.com\\">\\n      <img src=\\"img/social/twitter.png\\" alt=\\"twitter logo\\" />\\n    </a>\\n  </div>\\n</footer>\\n\\n<style>\\n  main {\\n    flex: 1;\\n    display: flex;\\n    flex-direction: column;\\n    width: 92%;\\n    margin: 0 auto;\\n    box-sizing: border-box;\\n  }\\n\\n  footer {\\n    display: flex;\\n    flex-direction: column;\\n    justify-content: center;\\n    align-items: center;\\n    margin-top: var(--top-margin-mobile);\\n  }\\n\\n  footer a {\\n    font-weight: bold;\\n    text-decoration: none;\\n  }\\n\\n  footer p {\\n    width: 92%;\\n    max-width: 1024px;\\n    margin: 0 auto;\\n  }\\n\\n  .social-icons {\\n    display: grid;\\n    grid-template-columns: repeat(3, 1fr);\\n    margin-top: 2.875rem;\\n    margin-bottom: 1.5rem;\\n    gap: 1rem;\\n  }\\n\\n  .social-icons img {\\n    display: block;\\n    width: 100%;\\n    max-width: 28px;\\n  }\\n\\n  @media (min-width: 768px) {\\n    footer {\\n      padding-top: var(--column-margin-top);\\n    }\\n  }\\n</style>\\n"],"names":[],"mappings":"AAgCE,IAAI,8BAAC,CAAC,AACJ,IAAI,CAAE,CAAC,CACP,OAAO,CAAE,IAAI,CACb,cAAc,CAAE,MAAM,CACtB,KAAK,CAAE,GAAG,CACV,MAAM,CAAE,CAAC,CAAC,IAAI,CACd,UAAU,CAAE,UAAU,AACxB,CAAC,AAED,MAAM,8BAAC,CAAC,AACN,OAAO,CAAE,IAAI,CACb,cAAc,CAAE,MAAM,CACtB,eAAe,CAAE,MAAM,CACvB,WAAW,CAAE,MAAM,CACnB,UAAU,CAAE,IAAI,mBAAmB,CAAC,AACtC,CAAC,AAED,qBAAM,CAAC,CAAC,eAAC,CAAC,AACR,WAAW,CAAE,IAAI,CACjB,eAAe,CAAE,IAAI,AACvB,CAAC,AAED,qBAAM,CAAC,CAAC,eAAC,CAAC,AACR,KAAK,CAAE,GAAG,CACV,SAAS,CAAE,MAAM,CACjB,MAAM,CAAE,CAAC,CAAC,IAAI,AAChB,CAAC,AAED,aAAa,8BAAC,CAAC,AACb,OAAO,CAAE,IAAI,CACb,qBAAqB,CAAE,OAAO,CAAC,CAAC,CAAC,GAAG,CAAC,CACrC,UAAU,CAAE,QAAQ,CACpB,aAAa,CAAE,MAAM,CACrB,GAAG,CAAE,IAAI,AACX,CAAC,AAED,4BAAa,CAAC,GAAG,eAAC,CAAC,AACjB,OAAO,CAAE,KAAK,CACd,KAAK,CAAE,IAAI,CACX,SAAS,CAAE,IAAI,AACjB,CAAC,AAED,MAAM,AAAC,YAAY,KAAK,CAAC,AAAC,CAAC,AACzB,MAAM,8BAAC,CAAC,AACN,WAAW,CAAE,IAAI,mBAAmB,CAAC,AACvC,CAAC,AACH,CAAC"}`
};
var _layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css$b);
  return `${validate_component(Canvas, "Canvas").$$render($$result, {}, {}, {})}

<main class="${"svelte-1fndun0"}">${slots.default ? slots.default({}) : ``}</main>

<footer class="${"svelte-1fndun0"}"><p class="${"svelte-1fndun0"}">Thank you for visiting. <a href="${"mailto:dkibui@visign.co.ke"}" class="${"svelte-1fndun0"}">Send us an email
    </a>
    to see how we can help.
  </p>
  <div class="${"social-icons svelte-1fndun0"}"><a href="${"https://www.behance.net"}" class="${"svelte-1fndun0"}"><img src="${"img/social/behance.png"}" alt="${"behance logo"}" class="${"svelte-1fndun0"}"></a>
    <a href="${"https://www.instagram.com"}" class="${"svelte-1fndun0"}"><img src="${"img/social/instagram.png"}" alt="${"instagram logo"}" class="${"svelte-1fndun0"}"></a>
    <a href="${"https://www.twitter.com"}" class="${"svelte-1fndun0"}"><img src="${"img/social/twitter.png"}" alt="${"twitter logo"}" class="${"svelte-1fndun0"}"></a></div>
</footer>`;
});
...
<div class="${"content-500 svelte-fxayyx"}"><h1 class="${"svelte-fxayyx"}">Our business is making yours look good.</h1>
  <p class="${"svelte-fxayyx"}">We provide brand centred graphic design and web development services to SMEs
    and corporates in Nairobi.
  </p></div>

<div class="${"content svelte-fxayyx"}">${validate_component(Swiper, "Swiper").$$render($$result, {
    slidesPerView: 3,
    spaceBetween: 10,
    slidesPerGroup: 1,
    mousewheel: false,
    ...
    default: () => `${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/recent/8.jpg"}" alt="${""}" class="${"svelte-fxayyx"}">`
    })}
    ${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/recent/2.jpg"}" alt="${""}" class="${"svelte-fxayyx"}">`
    })}
    ${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/recent/11.jpg"}" alt="${""}" class="${"svelte-fxayyx"}">`
    })}
    ${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/recent/9.jpg"}" alt="${""}" class="${"svelte-fxayyx"}">`
    })}
    ${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/recent/55.jpg"}" alt="${""}" class="${"svelte-fxayyx"}">`
    })}
    ${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/recent/6.jpg"}" alt="${""}" class="${"svelte-fxayyx"}">`
    })}
    ${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/recent/liberte.jpg"}" alt="${""}" class="${"svelte-fxayyx"}">`
    })}`
  })}</div>

<div class="${"services svelte-fxayyx"}"><h2 class="${"svelte-fxayyx"}">Our services</h2>
  <div class="${"accordion svelte-fxayyx"}">${each$1(Object.entries(data), (entry) => `${validate_component(Accordion, "Accordion").$$render($$result, { entry }, {}, {})}`)}</div></div>

<div class="${"recent svelte-fxayyx"}"><h2 class="${"svelte-fxayyx"}">Recent projects</h2>
  <p class="${"recent__text svelte-fxayyx"}">We handle many full brand development projects. Below we showcase the ones
    we completed recently
  </p></div>

<div class="${"four-way-grid svelte-fxayyx"}">${validate_component(Recent, "Recent").$$render($$result, {}, {}, {})}</div>

<div class="${"clients svelte-fxayyx"}"><h2 class="${"svelte-fxayyx"}">Our clients</h2>
  <p class="${"svelte-fxayyx"}">We work with companies of all sizes. Start-ups, SMES or corporates.
    Regardless of your size our goal is always the same, do work that helps you
    stand out in the market place.
  </p></div>

<div class="${"logos svelte-fxayyx"}">${validate_component(Swiper, "Swiper").$$render($$result, {
    slidesPerView: 3,
    spaceBetween: 20,
    slidesPerGroup: 1,
    mousewheel: false,
    ...
    default: () => `${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/logos/amsco.png"}" alt="${"amsco logo"}" class="${"svelte-fxayyx"}">`
    })}
    
    ${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/logos/anchor.png"}" alt="${"Anchor builders logo"}" class="${"svelte-fxayyx"}">`
    })}
    ${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/logos/strathmore.png"}" alt="${"Strathmore University logo"}" class="${"svelte-fxayyx"}">`
    })}
    ${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/logos/eaglehr.png"}" alt="${"Eaglehr kenya logo"}" class="${"svelte-fxayyx"}">`
    })}
    ${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/logos/absa.png"}" alt="${"absa bank logo"}" class="${"svelte-fxayyx"}">`
    })}
    ${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/logos/farmhouse.png"}" alt="${"farmhouse sacco logo"}" class="${"svelte-fxayyx"}">`
    })}`
  })}
</div>`;
});
