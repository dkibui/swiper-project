...
function init(settings = default_settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: assets + "/_app/start-465e600a.js",
      css: [assets + "/_app/assets/start-61d1577b.css"],
      js: [assets + "/_app/start-465e600a.js", assets + "/_app/chunks/vendor-a533b0b9.js"]
    },
    fetched: void 0,
    floc: false,
...
<div class="${"content-500 svelte-68vhsd"}"><h1>Anchor homes branding project.</h1>
  <p class="${"svelte-68vhsd"}">Anchor approached us to imagine their branding. Our objective for this
    project was to create a sense of trust and closeness with potential home
    owners by using simple and down to earth communication.
  </p>
  <p class="${"svelte-68vhsd"}">Our approach and implementation for this project was based on simplicity and
    clarity.
  </p></div>

<article class="${"width bg-color img-width hero svelte-68vhsd"}"><div class="${"svelte-68vhsd"}"><img src="${"img/recent/anchor hero.png"}" alt="${"anchor"}" class="${"svelte-68vhsd"}"></div></article>

<div class="${"width work-wrapper svelte-68vhsd"}"><div class="${"recent-work"}"><section class="${"two-way-grid"}">${validate_component(TwoWayGrid, "TwoWayGrid").$$render($$result, {}, {}, {
    right: () => `<div slot="${"right"}" class="${"img-wrapper svelte-68vhsd"}"><img src="${"img/recent/1.jpg"}" alt="${"eaglehr"}" class="${"svelte-68vhsd"}"></div>`,
    left: () => `<div slot="${"left"}" class="${"img-wrapper svelte-68vhsd"}"><img src="${"img/recent/2.jpg"}" alt="${"eaglehr"}" class="${"svelte-68vhsd"}"></div>`
  })}</section></div></div>

<div class="${"intersection width svelte-68vhsd"}"><h2 class="${"svelte-68vhsd"}">Anchor homes brand application</h2>
  <p class="${"svelte-68vhsd"}">We explored different ideas to come up with the brand logo. We then selected
    brand colours and typeface. Below we showcase how we apply the logo to
    different communication medium.
  </p></div>

<div class="${"width work-wrapper svelte-68vhsd"}"><div class="${"recent-work"}"><section class="${"two-way-grid"}">${validate_component(TwoWayGrid, "TwoWayGrid").$$render($$result, {}, {}, {
    right: () => `<div slot="${"right"}" class="${"img-wrapper svelte-68vhsd"}"><img src="${"img/recent/anchor advert.jpg"}" alt="${"anchor construction advert"}" class="${"svelte-68vhsd"}"></div>`,
    left: () => `<div slot="${"left"}" class="${"img-wrapper svelte-68vhsd"}"><img src="${"img/recent/anchor-elements.jpg"}" alt="${"anchor"}" class="${"svelte-68vhsd"}"></div>`
  })}</section></div></div>

<div class="${"bg-white width svelte-68vhsd"}"><img src="${"img/recent/branded.png"}" alt="${"anchor one"}" class="${"svelte-68vhsd"}"></div>

<div class="${"width img-width three-way-grid svelte-68vhsd"}">${validate_component(ThreeWayGrid, "ThreeWayGrid").$$render($$result, {}, {}, {
    right: () => `<img slot="${"right"}" src="${"img/recent/7.jpg"}" alt="${"anchor tshirt branding"}" class="${"svelte-68vhsd"}">`,
    center: () => `<img slot="${"center"}" src="${"img/recent/brochure.jpg"}" alt="${"anchor one"}" class="${"svelte-68vhsd"}">`,
    left: () => `<img slot="${"left"}" src="${"img/recent/carrier bags.jpg"}" alt="${"anchor one"}" class="${"svelte-68vhsd"}">`
  })}</div>

<div class="${"width single-img svelte-68vhsd"}"><img src="${"img/recent/calendar.jpg"}" alt="${"anchor one"}" class="${"svelte-68vhsd"}">
</div>`;
});
