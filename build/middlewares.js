...
function init(settings = default_settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: assets + "/_app/start-a2b22c8e.js",
      css: [assets + "/_app/assets/start-61d1577b.css"],
      js: [assets + "/_app/start-a2b22c8e.js", assets + "/_app/chunks/vendor-a533b0b9.js"]
    },
    fetched: void 0,
    floc: false,
...
<div class="${"content-500 svelte-1gitznl"}"><h1>Anchor homes branding project.</h1>
  <p class="${"svelte-1gitznl"}">Anchor approached us to imagine their branding. For this project we wanted
    to create a brand that is emotional and caring. A brand that lets you know
    we&#39;ve got your back.
  </p>
  <p class="${"svelte-1gitznl"}">We hope to establish trust with potential home owners by using simple and
    down to earth communication.
  </p></div>
...
<div class="${"intersection width svelte-1gitznl"}"><h2 class="${"svelte-1gitznl"}">Anchor identity</h2>
  <p class="${"svelte-1gitznl"}">To establish Anchor&#39;s identity we, we carefully selected five colours,
    created a brand pattern, chose a typeface and created a guide on image use.
    All together these elements create a recognisable and unique brand.
  </p></div>
...
<div class="${"intersection width svelte-1gitznl"}"><h2 class="${"svelte-1gitznl"}">Anchor identity application</h2>
  <p class="${"svelte-1gitznl"}">We explored different ideas to come up with the brand logo. We then selected
    brand colours and typeface. Below we showcase how we apply the logo to
    different communication medium.
  </p></div>
...
<div class="${"width single-img svelte-1gitznl"}"><img src="${"img/recent/calendar.jpg"}" alt="${"anchor one"}" class="${"svelte-1gitznl"}"></div>
<div class="${"width single-img svelte-1gitznl"}"><img src="${"img/recent/anchor-helmet.jpg"}" alt="${"anchor one"}" class="${"svelte-1gitznl"}">
</div>`;
});
