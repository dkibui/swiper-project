...
function init(settings = default_settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: assets + "/_app/start-bcb517ce.js",
      css: [assets + "/_app/assets/start-61d1577b.css"],
      js: [assets + "/_app/start-bcb517ce.js", assets + "/_app/chunks/vendor-7aaed8c5.js"]
    },
    fetched: void 0,
    floc: false,
...
var css$d = {
  code: "section.svelte-1unafmu{max-width:1400px;margin:auto}section.svelte-1unafmu{display:grid;grid-template-columns:repeat(2, 1fr);gap:2.2rem;column-gap:0.25rem}@media(min-width: 768px){section.svelte-1unafmu{gap:0.75rem}}@media(min-width: 1068px){section.svelte-1unafmu{grid-template-columns:repeat(4, 1fr)}}",
  map: '{"version":3,"file":"FourWayGrid.svelte","sources":["FourWayGrid.svelte"],"sourcesContent":["<section>\\r\\n  <slot />\\r\\n  <!-- <div>\\r\\n    <slot name=\\"one\\" />\\r\\n  </div>\\r\\n  <div>\\r\\n    <slot name=\\"two\\" />\\r\\n  </div>\\r\\n  <div>\\r\\n    <slot name=\\"three\\" />\\r\\n  </div>\\r\\n  <div>\\r\\n    <slot name=\\"four\\" />\\r\\n  </div> -->\\r\\n</section>\\r\\n\\r\\n<style>\\r\\n  section {\\r\\n    max-width: 1400px;\\r\\n    margin: auto;\\r\\n  }\\r\\n\\r\\n  section {\\r\\n    display: grid;\\r\\n    grid-template-columns: repeat(2, 1fr);\\r\\n    gap: 2.2rem;\\r\\n    column-gap: 0.25rem;\\r\\n  }\\r\\n\\r\\n  @media (min-width: 768px) {\\r\\n    section {\\r\\n      gap: 0.75rem;\\r\\n    }\\r\\n  }\\r\\n\\r\\n  @media (min-width: 1068px) {\\r\\n    section {\\r\\n      grid-template-columns: repeat(4, 1fr);\\r\\n    }\\r\\n  }\\r\\n</style>\\r\\n"],"names":[],"mappings":"AAiBE,OAAO,eAAC,CAAC,AACP,SAAS,CAAE,MAAM,CACjB,MAAM,CAAE,IAAI,AACd,CAAC,AAED,OAAO,eAAC,CAAC,AACP,OAAO,CAAE,IAAI,CACb,qBAAqB,CAAE,OAAO,CAAC,CAAC,CAAC,GAAG,CAAC,CACrC,GAAG,CAAE,MAAM,CACX,UAAU,CAAE,OAAO,AACrB,CAAC,AAED,MAAM,AAAC,YAAY,KAAK,CAAC,AAAC,CAAC,AACzB,OAAO,eAAC,CAAC,AACP,GAAG,CAAE,OAAO,AACd,CAAC,AACH,CAAC,AAED,MAAM,AAAC,YAAY,MAAM,CAAC,AAAC,CAAC,AAC1B,OAAO,eAAC,CAAC,AACP,qBAAqB,CAAE,OAAO,CAAC,CAAC,CAAC,GAAG,CAAC,AACvC,CAAC,AACH,CAAC"}'
};
var FourWayGrid = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css$d);
  return `<section class="${"svelte-1unafmu"}">${slots.default ? slots.default({}) : ``}
...
<div class="${"content svelte-tje1k9"}">${validate_component(Swiper, "Swiper").$$render($$result, {
    ...
    default: () => `${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/recent/11.jpg"}" alt="${"Anchor homes"}" class="${"svelte-tje1k9"}">`
    })}
    ${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/recent/9.jpg"}" alt="${"Anchor homes"}" class="${"svelte-tje1k9"}">`
    })}
    ${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/recent/amsco.jpg"}" alt="${"amsco"}" class="${"svelte-tje1k9"}">`
    })}
    ${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/recent/6.jpg"}" alt="${"liberte juices post"}" class="${"svelte-tje1k9"}">`
    })}
    ${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/recent/liberte.jpg"}" alt="${"liberte juices"}" class="${"svelte-tje1k9"}">`
    })}
    ${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
...
<div class="${"recent svelte-tje1k9"}"><h2>Sample work</h2>
  <p class="${"top-margin svelte-tje1k9"}">We have been involved in many brand development projects. Below see some
    that we completed recently
  </p></div>
