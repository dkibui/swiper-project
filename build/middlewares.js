...
function init(settings = default_settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: assets + "/_app/start-130d66c6.js",
      css: [assets + "/_app/assets/start-61d1577b.css"],
      js: [assets + "/_app/start-130d66c6.js", assets + "/_app/chunks/vendor-5b13c1bf.js"]
    },
    fetched: void 0,
    floc: false,
...
var metadata_lookup = { "src/routes/__layout.svelte": { "entry": "pages/__layout.svelte-fec566ae.js", "css": ["assets/pages/__layout.svelte-62b7240a.css"], "js": ["pages/__layout.svelte-fec566ae.js", "chunks/vendor-5b13c1bf.js"], "styles": [] }, ".svelte-kit/build/components/error.svelte": { "entry": "error.svelte-f83dac7d.js", "css": [], "js": ["error.svelte-f83dac7d.js", "chunks/vendor-5b13c1bf.js"], "styles": [] }, "src/routes/index.svelte": { "entry": "pages/index.svelte-b530b833.js", "css": ["assets/pages/index.svelte-8d52b133.css", "assets/pagination.min-4d3a60e0.css"], "js": ["pages/index.svelte-b530b833.js", "chunks/vendor-5b13c1bf.js"], "styles": [] }, "src/routes/about.svelte": { "entry": "pages/about.svelte-770c2bdf.js", "css": ["assets/pages/about.svelte-de8cddf4.css", "assets/pagination.min-4d3a60e0.css"], "js": ["pages/about.svelte-770c2bdf.js", "chunks/vendor-5b13c1bf.js"], "styles": [] }, "src/routes/test.svelte": { "entry": "pages/test.svelte-37b5c0f6.js", "css": ["assets/pages/test.svelte-8c87b7d1.css"], "js": ["pages/test.svelte-37b5c0f6.js", "chunks/vendor-5b13c1bf.js"], "styles": [] }, "src/routes/work.svelte": { "entry": "pages/work.svelte-52d50c61.js", "css": ["assets/pages/work.svelte-a3b0a6d6.css"], "js": ["pages/work.svelte-52d50c61.js", "chunks/vendor-5b13c1bf.js"], "styles": [] } };
...
var Accordion = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="${"btn svelte-44qllc"}"${add_attribute("aria-expanded", isOpen, 0)}><svg style="${"tran"}" width="${"20"}" height="${"20"}" fill="${"none"}" stroke-linecap="${"round"}" stroke-linejoin="${"round"}" stroke-width="${"2"}" viewBox="${"0 0 24 24"}" stroke="${"currentColor"}" class="${"svelte-44qllc"}"><path d="${"M9 5l7 7-7 7"}"></path></svg>
  <p class="${"svelte-44qllc"}">${escape(entry[0])}</p></div>
...
var css$3 = {
  code: ".btn.svelte-44sjro.svelte-44sjro{display:flex;align-items:center;background-color:rgb(125, 183, 202);padding:0.5rem 1.125rem;padding-left:0.425em;margin-top:2rem}.btn.svelte-44sjro svg.svelte-44sjro{display:inline-block}.btn.svelte-44sjro p.svelte-44sjro{display:inline-block;font-size:1.1em;margin-left:0.55em}div.svelte-44sjro.svelte-44sjro{background-color:lightblue;padding:1.2em}p.svelte-44sjro.svelte-44sjro{text-align:left}svg.svelte-44sjro.svelte-44sjro{transition:transform 0.3s ease-in-out}.svg.svelte-44sjro.svelte-44sjro{transform:rotate(0.25turn)}",
...
var Test = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="${"btn svelte-44sjro"}"><svg style="${"tran"}" width="${"20"}" height="${"17"}" fill="${"none"}" stroke-linecap="${"round"}" stroke-linejoin="${"round"}" stroke-width="${"2"}" viewBox="${"0 0 24 24"}" stroke="${"currentColor"}" class="${["svelte-44sjro", ""].join(" ").trim()}"><path d="${"M9 5l7 7-7 7"}"></path></svg>
  <p class="${"svelte-44sjro"}">Brand development services</p></div>

${``}
<p class="${"svelte-44sjro"}">Hello world</p>`;
});
