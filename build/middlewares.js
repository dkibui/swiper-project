...
function init(settings = default_settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: assets + "/_app/start-e9f17002.js",
      css: [assets + "/_app/assets/start-61d1577b.css"],
      js: [assets + "/_app/start-e9f17002.js", assets + "/_app/chunks/vendor-d5f9a42e.js"]
    },
    fetched: void 0,
    floc: false,
...
var metadata_lookup = { "src/routes/__layout.svelte": { "entry": "pages/__layout.svelte-57767e9e.js", "css": ["assets/pages/__layout.svelte-bf76a9c3.css"], "js": ["pages/__layout.svelte-57767e9e.js", "chunks/vendor-d5f9a42e.js"], "styles": [] }, ".svelte-kit/build/components/error.svelte": { "entry": "error.svelte-12259f80.js", "css": [], "js": ["error.svelte-12259f80.js", "chunks/vendor-d5f9a42e.js"], "styles": [] }, "src/routes/index.svelte": { "entry": "pages/index.svelte-03c7193f.js", "css": ["assets/pages/index.svelte-e0b44412.css", "assets/pagination.min-4d3a60e0.css", "assets/Recent-85ab13f4.css"], "js": ["pages/index.svelte-03c7193f.js", "chunks/vendor-d5f9a42e.js", "chunks/Recent-0dd2b1bd.js"], "styles": [] }, "src/routes/collapsible.svelte": { "entry": "pages/collapsible.svelte-ff695608.js", "css": [], "js": ["pages/collapsible.svelte-ff695608.js", "chunks/vendor-d5f9a42e.js"], "styles": [] }, "src/routes/about.svelte": { "entry": "pages/about.svelte-855b7767.js", "css": ["assets/pages/about.svelte-de8cddf4.css", "assets/pagination.min-4d3a60e0.css"], "js": ["pages/about.svelte-855b7767.js", "chunks/vendor-d5f9a42e.js"], "styles": [] }, "src/routes/menu.svelte": { "entry": "pages/menu.svelte-509d56b8.js", "css": [], "js": ["pages/menu.svelte-509d56b8.js", "chunks/vendor-d5f9a42e.js"], "styles": [] }, "src/routes/test.svelte": { "entry": "pages/test.svelte-aede87f7.js", "css": ["assets/pages/test.svelte-4d6faebe.css", "assets/Recent-85ab13f4.css"], "js": ["pages/test.svelte-aede87f7.js", "chunks/vendor-d5f9a42e.js", "chunks/Recent-0dd2b1bd.js"], "styles": [] }, "src/routes/work.svelte": { "entry": "pages/work.svelte-9ffb2e3c.js", "css": ["assets/pages/work.svelte-b11f963d.css"], "js": ["pages/work.svelte-9ffb2e3c.js", "chunks/vendor-d5f9a42e.js"], "styles": [] } };
...
var css$8 = {
  code: "article.svelte-gv7dj{padding:0.875rem;max-width:500px;background-color:white;border-radius:8px;display:flex;flex-direction:column;gap:0.75rem}.img.svelte-gv7dj{border-bottom-left-radius:32px;border-bottom-right-radius:32px;overflow:hidden;margin-bottom:1rem}@media(min-width: 768px){}",
  map: `{"version":3,"file":"RecentCard.svelte","sources":["RecentCard.svelte"],"sourcesContent":["<script>\\r\\n  export let img = 'img'\\r\\n<\/script>\\r\\n\\r\\n<article>\\r\\n  <div class={img}>\\r\\n    <slot name=\\"image\\" />\\r\\n  </div>\\r\\n  <div>\\r\\n    <slot name=\\"description\\" />\\r\\n  </div>\\r\\n  <div>\\r\\n    <slot name=\\"link\\" />\\r\\n  </div>\\r\\n</article>\\r\\n\\r\\n<style>\\r\\n  article {\\r\\n    padding: 0.875rem;\\r\\n    max-width: 500px;\\r\\n    background-color: white;\\r\\n    border-radius: 8px;\\r\\n    display: flex;\\r\\n    flex-direction: column;\\r\\n    gap: 0.75rem;\\r\\n  }\\r\\n\\r\\n  .img {\\r\\n    border-bottom-left-radius: 32px;\\r\\n    border-bottom-right-radius: 32px;\\r\\n    overflow: hidden;\\r\\n    margin-bottom: 1rem;\\r\\n    /* -webkit-box-shadow: 0 8px 10px -6px rgba(0, 0, 0, 0.589);\\r\\n    -moz-box-shadow: 0 8px 10px -6px rgba(0, 0, 0, 0.589);\\r\\n    box-shadow: 0 8px 10px -6px rgba(0, 0, 0, 0.589); */\\r\\n  }\\r\\n\\r\\n  @media (min-width: 768px) {\\r\\n  }\\r\\n</style>\\r\\n"],"names":[],"mappings":"AAiBE,OAAO,aAAC,CAAC,AACP,OAAO,CAAE,QAAQ,CACjB,SAAS,CAAE,KAAK,CAChB,gBAAgB,CAAE,KAAK,CACvB,aAAa,CAAE,GAAG,CAClB,OAAO,CAAE,IAAI,CACb,cAAc,CAAE,MAAM,CACtB,GAAG,CAAE,OAAO,AACd,CAAC,AAED,IAAI,aAAC,CAAC,AACJ,yBAAyB,CAAE,IAAI,CAC/B,0BAA0B,CAAE,IAAI,CAChC,QAAQ,CAAE,MAAM,CAChB,aAAa,CAAE,IAAI,AAIrB,CAAC,AAED,MAAM,AAAC,YAAY,KAAK,CAAC,AAAC,CAAC,AAC3B,CAAC"}`
};
var RecentCard = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<article class="${"svelte-gv7dj"}"><div class="${escape(null_to_empty(img)) + " svelte-gv7dj"}">${slots.image ? slots.image({}) : ``}</div>
  <div>${slots.description ? slots.description({}) : ``}</div>
  <div>${slots.link ? slots.link({}) : ``}</div>
</article>`;
});
var css$7 = {
  code: "img.svelte-otzxm6{display:block;max-width:100%;object-fit:cover;transition:transform 350ms ease-out}img.svelte-otzxm6:hover{transform:scale(1.025) rotate(2deg);-webkit-transform:scale(1.025) rotate(2deg);-moz-transform:scale(1.025) rotate(2deg)}p.svelte-otzxm6{text-align:left}",
...
var Recent = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(FourWayGrid, "FourWayGrid").$$render($$result, {}, {}, {
    default: () => `${each$1(cards, (card) => `${validate_component(RecentCard, "RecentCard").$$render($$result, {}, {}, {
      ...
      description: () => `<p slot="${"description"}" class="${"svelte-otzxm6"}">${escape(card.description)}</p>`,
      image: () => `<img slot="${"image"}"${add_attribute("src", card.image, 0)}${add_attribute("alt", card.alt, 0)} class="${"svelte-otzxm6"}">`
    })}`)}`
  })}`;
});
