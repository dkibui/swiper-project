...
function init(settings = default_settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: assets + "/_app/start-93e84d93.js",
      css: [assets + "/_app/assets/start-61d1577b.css"],
      js: [assets + "/_app/start-93e84d93.js", assets + "/_app/chunks/vendor-2f3453ae.js"]
    },
    fetched: void 0,
    floc: false,
...
var Accordion = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="${"btn svelte-cni3d1"}"${add_attribute("aria-expanded", isOpen, 0)}><p class="${"svelte-cni3d1"}">${escape(entry[0])}</p>
  <svg class="${"svg svelte-cni3d1"}" height="${"12"}" width="${"12"}"><line x1="${"0"}" y1="${"6"}" x2="${"12"}" y2="${"6"}"></line><line x1="${"6"}" y1="${"12"}" x2="${"6"}" y2="${"0"}"></line></svg></div>
