...
var template = ({ head, body }) => '<!DOCTYPE html>\n<html lang="en">\n  <head>\n    <meta charset="utf-8" />\n    <link rel="icon" href="/favicon.svg" />\n    <meta\n      name="description"\n      content="Creative design studio in Nairobi offering graphic design, web development, printing and branding services to small businesses as well as corporates. We have been in opration for more than 7 years. Get in touch with us to see how we can help you."\n    />\n    <meta name="viewport" content="width=device-width, initial-scale=1" />\n    ' + head + '\n  </head>\n  <body>\n    <div id="svelte">' + body + "</div>\n  </body>\n</html>\n";
var options = null;
...
function init(settings = default_settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: assets + "/_app/start-b25f179c.js",
      css: [assets + "/_app/assets/start-61d1577b.css"],
      js: [assets + "/_app/start-b25f179c.js", assets + "/_app/chunks/vendor-7aaed8c5.js"]
    },
    fetched: void 0,
    floc: false,
...
var empty = () => ({});
var manifest = {
  assets: [{ "file": "favicon.svg", "size": 2489, "type": "image/svg+xml" }, { "file": "img/Liberte juices.svg", "size": 16694, "type": "image/svg+xml" }, { "file": "img/logos/absa.png", "size": 5404, "type": "image/png" }, { "file": "img/logos/amsco.png", "size": 7737, "type": "image/png" }, { "file": "img/logos/anchor.png", "size": 5770, "type": "image/png" }, { "file": "img/logos/eaglehr.png", "size": 7162, "type": "image/png" }, { "file": "img/logos/EALaw.svg", "size": 7397, "type": "image/svg+xml" }, { "file": "img/logos/farmhouse.png", "size": 6717, "type": "image/png" }, { "file": "img/logos/Liberte.png", "size": 6293, "type": "image/png" }, { "file": "img/logos/maxed.png", "size": 11693, "type": "image/png" }, { "file": "img/logos/strathmore.png", "size": 16046, "type": "image/png" }, { "file": "img/recent/1.jpg", "size": 36259, "type": "image/jpeg" }, { "file": "img/recent/11.jpg", "size": 53888, "type": "image/jpeg" }, { "file": "img/recent/2.jpg", "size": 41863, "type": "image/jpeg" }, { "file": "img/recent/3.jpg", "size": 44989, "type": "image/jpeg" }, { "file": "img/recent/4.jpg", "size": 20441, "type": "image/jpeg" }, { "file": "img/recent/5.jpg", "size": 21425, "type": "image/jpeg" }, { "file": "img/recent/55.jpg", "size": 44268, "type": "image/jpeg" }, { "file": "img/recent/6.jpg", "size": 48291, "type": "image/jpeg" }, { "file": "img/recent/7.jpg", "size": 38270, "type": "image/jpeg" }, { "file": "img/recent/8.jpg", "size": 57827, "type": "image/jpeg" }, { "file": "img/recent/9.jpg", "size": 41379, "type": "image/jpeg" }, { "file": "img/recent/anchor cap.jpg", "size": 28098, "type": "image/jpeg" }, { "file": "img/recent/anchor hero.png", "size": 20269, "type": "image/png" }, { "file": "img/recent/anchor-advert.jpg", "size": 41639, "type": "image/jpeg" }, { "file": "img/recent/anchor-advert.png", "size": 46414, "type": "image/png" }, { "file": "img/recent/anchor-cap.jpg", "size": 26148, "type": "image/jpeg" }, { "file": "img/recent/anchor-elements.jpg", "size": 31639, "type": "image/jpeg" }, { "file": "img/recent/anchor-helmet.jpg", "size": 35570, "type": "image/jpeg" }, { "file": "img/recent/anchor.jpg", "size": 21223, "type": "image/jpeg" }, { "file": "img/recent/branded.jpg", "size": 94767, "type": "image/jpeg" }, { "file": "img/recent/branded.png", "size": 208617, "type": "image/png" }, { "file": "img/recent/brochure.jpg", "size": 27659, "type": "image/jpeg" }, { "file": "img/recent/calendar.jpg", "size": 58355, "type": "image/jpeg" }, { "file": "img/recent/carrier bags.jpg", "size": 13156, "type": "image/jpeg" }, { "file": "img/recent/eaglehr-banners.jpg", "size": 42537, "type": "image/jpeg" }, { "file": "img/recent/eaglehr.jpg", "size": 11185, "type": "image/jpeg" }, { "file": "img/recent/giftbags.jpg", "size": 13246, "type": "image/jpeg" }, { "file": "img/recent/graphicdesign.png", "size": 48568, "type": "image/png" }, { "file": "img/recent/hanging-banner.jpg", "size": 37844, "type": "image/jpeg" }, { "file": "img/recent/imexafrica.jpg", "size": 19662, "type": "image/jpeg" }, { "file": "img/recent/liberte.jpg", "size": 35629, "type": "image/jpeg" }, { "file": "img/recent/liberte_project.jpg", "size": 38433, "type": "image/jpeg" }, { "file": "img/recent/mask.jpg", "size": 10759, "type": "image/jpeg" }, { "file": "img/recent/not compressed/11.jpg", "size": 601456, "type": "image/jpeg" }, { "file": "img/recent/not compressed/2.jpg", "size": 41863, "type": "image/jpeg" }, { "file": "img/recent/not compressed/3.jpg", "size": 47763, "type": "image/jpeg" }, { "file": "img/recent/not compressed/5.jpg", "size": 22426, "type": "image/jpeg" }, { "file": "img/recent/not compressed/55.jpg", "size": 243774, "type": "image/jpeg" }, { "file": "img/recent/not compressed/6.jpg", "size": 373999, "type": "image/jpeg" }, { "file": "img/recent/not compressed/7.jpg", "size": 218898, "type": "image/jpeg" }, { "file": "img/recent/not compressed/8.jpg", "size": 226716, "type": "image/jpeg" }, { "file": "img/recent/not compressed/9.jpg", "size": 343021, "type": "image/jpeg" }, { "file": "img/recent/not compressed/anchor advert.jpg", "size": 301944, "type": "image/jpeg" }, { "file": "img/recent/not compressed/anchor cap.jpg", "size": 176842, "type": "image/jpeg" }, { "file": "img/recent/not compressed/anchor-helmet.jpg", "size": 997601, "type": "image/jpeg" }, { "file": "img/recent/not compressed/anchor.jpg", "size": 61221, "type": "image/jpeg" }, { "file": "img/recent/not compressed/brochure.jpg", "size": 142644, "type": "image/jpeg" }, { "file": "img/recent/not compressed/carrier bags.jpg", "size": 106129, "type": "image/jpeg" }, { "file": "img/recent/not compressed/eaglehr-banners.jpg", "size": 568186, "type": "image/jpeg" }, { "file": "img/recent/not compressed/eaglehr.jpg", "size": 116766, "type": "image/jpeg" }, { "file": "img/recent/not compressed/giftbags.jpg", "size": 17279, "type": "image/jpeg" }, { "file": "img/recent/not compressed/graphic-design.png", "size": 227392, "type": "image/png" }, { "file": "img/recent/not compressed/hanging-banner.jpg", "size": 194342, "type": "image/jpeg" }, { "file": "img/recent/not compressed/imexafrica.jpg", "size": 46747, "type": "image/jpeg" }, { "file": "img/recent/not compressed/liberte.jpg", "size": 223477, "type": "image/jpeg" }, { "file": "img/recent/not compressed/liberte_project.jpg", "size": 50930, "type": "image/jpeg" }, { "file": "img/recent/not compressed/table-calendar.jpg", "size": 170130, "type": "image/jpeg" }, { "file": "img/recent/poloshirts.jpg", "size": 86487, "type": "image/jpeg" }, { "file": "img/recent/table-calendar.jpg", "size": 42305, "type": "image/jpeg" }, { "file": "img/social/behance.png", "size": 3229, "type": "image/png" }, { "file": "img/social/instagram.png", "size": 3577, "type": "image/png" }, { "file": "img/social/twitter.png", "size": 3001, "type": "image/png" }, { "file": "img/tinified.zip", "size": 206254, "type": "application/zip" }, { "file": "img/visign-logo.svg", "size": 2657, "type": "image/svg+xml" }],
...
var metadata_lookup = { "src/routes/__layout.svelte": { "entry": "pages/__layout.svelte-00dff4e8.js", "css": ["assets/pages/__layout.svelte-237f132d.css"], "js": ["pages/__layout.svelte-00dff4e8.js", "chunks/vendor-7aaed8c5.js"], "styles": [] }, ".svelte-kit/build/components/error.svelte": { "entry": "error.svelte-f46a7fc1.js", "css": [], "js": ["error.svelte-f46a7fc1.js", "chunks/vendor-7aaed8c5.js"], "styles": [] }, "src/routes/index.svelte": { "entry": "pages/index.svelte-d02ca98c.js", "css": ["assets/pages/index.svelte-065c815e.css", "assets/pagination.min-4d3a60e0.css"], "js": ["pages/index.svelte-d02ca98c.js", "chunks/vendor-7aaed8c5.js"], "styles": [] }, "src/routes/contact.svelte": { "entry": "pages/contact.svelte-1bcca0b2.js", "css": ["assets/pages/contact.svelte-4cd1b3be.css"], "js": ["pages/contact.svelte-1bcca0b2.js", "chunks/vendor-7aaed8c5.js"], "styles": [] }, "src/routes/about.svelte": { "entry": "pages/about.svelte-e1a89867.js", "css": ["assets/pages/about.svelte-de8cddf4.css", "assets/pagination.min-4d3a60e0.css"], "js": ["pages/about.svelte-e1a89867.js", "chunks/vendor-7aaed8c5.js"], "styles": [] }, "src/routes/blog.svelte": { "entry": "pages/blog.svelte-1847601a.js", "css": ["assets/pages/blog.svelte-cc5d0f05.css"], "js": ["pages/blog.svelte-1847601a.js", "chunks/vendor-7aaed8c5.js"], "styles": [] }, "src/routes/plus.svelte": { "entry": "pages/plus.svelte-570b7cef.js", "css": ["assets/pages/plus.svelte-67719f8d.css"], "js": ["pages/plus.svelte-570b7cef.js", "chunks/vendor-7aaed8c5.js"], "styles": [] }, "src/routes/test.svelte": { "entry": "pages/test.svelte-123f3472.js", "css": ["assets/pages/test.svelte-6e2f192b.css"], "js": ["pages/test.svelte-123f3472.js", "chunks/vendor-7aaed8c5.js"], "styles": [] }, "src/routes/work.svelte": { "entry": "pages/work.svelte-c9f7d8bd.js", "css": ["assets/pages/work.svelte-a9a0dadb.css"], "js": ["pages/work.svelte-c9f7d8bd.js", "chunks/vendor-7aaed8c5.js"], "styles": [] }, "src/routes/try.svelte": { "entry": "pages/try.svelte-5c3d440a.js", "css": ["assets/pages/try.svelte-11399192.css"], "js": ["pages/try.svelte-5c3d440a.js", "chunks/vendor-7aaed8c5.js"], "styles": [] } };
...
<div class="${"navigation svelte-1jlnsck"}"><div class="${"menu svelte-1jlnsck"}"><div class="${"logo"}"><a href="${"/"}"><img src="${"img/visign-logo.svg"}" alt="${"visign kenya logo"}" class="${"svelte-1jlnsck"}"></a></div>
  ...
  <div id="${"mySidenav"}" class="${["sidenav svelte-1jlnsck", ""].join(" ").trim()}">
    ...
    <a href="${"/blog"}" class="${"svelte-1jlnsck"}">Blog</a>
    <a href="${"/contact"}" class="${"svelte-1jlnsck"}">Contact</a>
...
var Accordion = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="${"btn svelte-1ese3ry"}"${add_attribute("aria-expanded", isOpen, 0)}><p class="${"svelte-1ese3ry"}">${escape(entry[0])}</p>
  <svg class="${"svg svelte-1ese3ry"}" height="${"12"}" width="${"12"}"><line x1="${"0"}" y1="${"6"}" x2="${"12"}" y2="${"6"}"></line><line x1="${"6"}" y1="${"12"}" x2="${"6"}" y2="${"0"}"></line></svg></div>
...
<div class="${"content-500 svelte-pdzmzj"}"><h1 class="${"svelte-pdzmzj"}">Our business is making yours look good.</h1>
  <p class="${"svelte-pdzmzj"}">We provide brand centred graphic design and web development services to SMEs
    and corporates in Nairobi.
  </p></div>

<div class="${"content svelte-pdzmzj"}">${validate_component(Swiper, "Swiper").$$render($$result, {
    slidesPerView: 3,
    spaceBetween: 10,
    slidesPerGroup: 1,
    mousewheel: false,
    ...
    default: () => `${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/recent/8.jpg"}" alt="${""}" class="${"svelte-pdzmzj"}">`
    })}
    ${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/recent/11.jpg"}" alt="${""}" class="${"svelte-pdzmzj"}">`
    })}
    ${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/recent/9.jpg"}" alt="${""}" class="${"svelte-pdzmzj"}">`
    })}
    ${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/recent/eaglehr-banners.jpg"}" alt="${""}" class="${"svelte-pdzmzj"}">`
    })}
    ${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/recent/55.jpg"}" alt="${""}" class="${"svelte-pdzmzj"}">`
    })}
    ${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/recent/6.jpg"}" alt="${""}" class="${"svelte-pdzmzj"}">`
    })}
    ${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/recent/liberte.jpg"}" alt="${""}" class="${"svelte-pdzmzj"}">`
    })}`
  })}</div>

<div class="${"services svelte-pdzmzj"}"><h2 class="${"svelte-pdzmzj"}">Our services</h2>
  <div class="${"accordion svelte-pdzmzj"}">${each$1(Object.entries(data), (entry) => `<div class="${"accordion-entry svelte-pdzmzj"}">${validate_component(Accordion, "Accordion").$$render($$result, { entry }, {}, {})}
      </div>`)}</div></div>

<div class="${"recent svelte-pdzmzj"}"><h2 class="${"svelte-pdzmzj"}">Recent projects</h2>
  <p class="${"recent__text svelte-pdzmzj"}">We handle many full brand development projects. Below we showcase the ones
    we completed recently
  </p></div>

<div class="${"four-way-grid svelte-pdzmzj"}">${validate_component(Recent, "Recent").$$render($$result, {}, {}, {})}</div>

<div class="${"clients svelte-pdzmzj"}"><h2 class="${"svelte-pdzmzj"}">Our clients</h2>
  <p class="${"svelte-pdzmzj"}">We work with companies of all sizes. Start-ups, SMES or corporates.
    Regardless of your size our goal is always the same, do work that helps you
    stand out in the market place.
  </p></div>

<div class="${"logos svelte-pdzmzj"}">${validate_component(Swiper, "Swiper").$$render($$result, {
    slidesPerView: 3,
    spaceBetween: 20,
    slidesPerGroup: 1,
    mousewheel: false,
    ...
    default: () => `${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/logos/amsco.png"}" alt="${"amsco logo"}" class="${"svelte-pdzmzj"}">`
    })}
    
    ${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/logos/anchor.png"}" alt="${"Anchor builders logo"}" class="${"svelte-pdzmzj"}">`
    })}
    ${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/logos/strathmore.png"}" alt="${"Strathmore University logo"}" class="${"svelte-pdzmzj"}">`
    })}
    ${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/logos/eaglehr.png"}" alt="${"Eaglehr kenya logo"}" class="${"svelte-pdzmzj"}">`
    })}
    ${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/logos/absa.png"}" alt="${"absa bank logo"}" class="${"svelte-pdzmzj"}">`
    })}
    ${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/logos/farmhouse.png"}" alt="${"farmhouse sacco logo"}" class="${"svelte-pdzmzj"}">`
    })}`
  })}
</div>`;
});
...
<div class="${"content-500 svelte-1nkc1lw"}"><h1>Contact us</h1>
  <p class="${"svelte-1nkc1lw"}">We&#39;re here for you. Give us a call or send us an Email.</p>
  <p class="${"svelte-1nkc1lw"}">Our goal is to provide you professional brand development services at a
    price you can afford. We&#39;re really excited to work with you. Your brand&#39;s
    journey to the next level begins now.
  </p>
  <a href="${"mailto:dkibui@visign.co.ke"}"><button class="${"svelte-1nkc1lw"}">Email us</button></a>

  <p class="${"contacts svelte-1nkc1lw"}">Cell: +254 728 49 4090 <br> Email: dkibui@visign.co.ke <br> Office: 6th
    Floor, Westend <br>
    Towers. Westlands Nairobi.
  </p>
</div>`;
...
<div class="${"content-500 svelte-15mjoas"}"><h1>Anchor homes branding.</h1>
  <p class="${"svelte-15mjoas"}">Anchor approached us to imagine their branding. For this project we wanted
    to create a brand that is emotional and caring. A brand that lets you know
    we&#39;ve got your back.
  </p>
  </div>

<article class="${"width bg-color img-width hero svelte-15mjoas"}"><div class="${"svelte-15mjoas"}"><img src="${"img/recent/anchor hero.png"}" alt="${"anchor"}" class="${"svelte-15mjoas"}"></div></article>

<div class="${"intersection width svelte-15mjoas"}"><h2 class="${"svelte-15mjoas"}">Our identity</h2>
  <p class="${"svelte-15mjoas"}">To establish Anchor&#39;s identity we, we selected brand colours and fonts. We
    created brand patterns and established guides on how to use the logo, images
    and colours. Put together these elements create a unique and recognisable
    brand.
  </p></div>

<div class="${"width work-wrapper svelte-15mjoas"}"><div class="${"recent-work"}"><section class="${"two-way-grid"}">${validate_component(TwoWayGrid, "TwoWayGrid").$$render($$result, {}, {}, {
    right: () => `<div slot="${"right"}" class="${"img-wrapper svelte-15mjoas"}"><img src="${"img/recent/1.jpg"}" alt="${"eaglehr"}" class="${"svelte-15mjoas"}"></div>`,
    left: () => `<div slot="${"left"}" class="${"img-wrapper svelte-15mjoas"}"><img src="${"img/recent/2.jpg"}" alt="${"eaglehr"}" class="${"svelte-15mjoas"}"></div>`
  })}</section></div></div>

<div class="${"width work-wrapper svelte-15mjoas"}"><div class="${"recent-work"}"><section class="${"two-way-grid"}">${validate_component(TwoWayGrid, "TwoWayGrid").$$render($$result, {}, {}, {
    right: () => `<div slot="${"right"}" class="${"img-wrapper svelte-15mjoas"}"><img src="${"img/recent/anchor-advert.jpg"}" alt="${"anchor construction advert"}" class="${"svelte-15mjoas"}"></div>`,
    left: () => `<div slot="${"left"}" class="${"img-wrapper svelte-15mjoas"}"><img src="${"img/recent/anchor-elements.jpg"}" alt="${"anchor"}" class="${"svelte-15mjoas"}"></div>`
  })}</section></div></div>

<div class="${"intersection width svelte-15mjoas"}"><h2 class="${"svelte-15mjoas"}">Identity and application</h2>
  <p class="${"svelte-15mjoas"}">Anchor&#39;s logo is versatile and adaptable in it&#39;s application. It works well
    in various forms of marketing communication.
  </p></div>

<div class="${"bg-white width svelte-15mjoas"}"><img src="${"img/recent/branded.png"}" alt="${"anchor one"}" class="${"svelte-15mjoas"}"></div>

<div class="${"width img-width three-way-grid svelte-15mjoas"}">${validate_component(ThreeWayGrid, "ThreeWayGrid").$$render($$result, {}, {}, {
    right: () => `<img slot="${"right"}" src="${"img/recent/7.jpg"}" alt="${"anchor tshirt branding"}" class="${"svelte-15mjoas"}">`,
    center: () => `<img slot="${"center"}" src="${"img/recent/anchor-cap.jpg"}" alt="${"anchor one"}" class="${"svelte-15mjoas"}">`,
    left: () => `<img slot="${"left"}" src="${"img/recent/carrier bags.jpg"}" alt="${"anchor one"}" class="${"svelte-15mjoas"}">`
  })}</div>

<div class="${"width work-wrapper svelte-15mjoas"}"><div class="${"recent-work"}"><section class="${"two-way-grid"}">${validate_component(TwoWayGrid, "TwoWayGrid").$$render($$result, {}, {}, {
    right: () => `<div slot="${"right"}" class="${"img-wrapper svelte-15mjoas"}"><img src="${"img/recent/anchor-helmet.jpg"}" alt="${"anchor helmet"}" class="${"svelte-15mjoas"}"></div>`,
    left: () => `<div slot="${"left"}" class="${"img-wrapper svelte-15mjoas"}"><img src="${"img/recent/hanging-banner.jpg"}" alt="${"anchor hanging banner"}" class="${"svelte-15mjoas"}"></div>`
  })}</section></div>
</div>`;
});
