...
function init(settings = default_settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: assets + "/_app/start-5ea245d7.js",
      css: [assets + "/_app/assets/start-61d1577b.css"],
      js: [assets + "/_app/start-5ea245d7.js", assets + "/_app/chunks/vendor-7aaed8c5.js"]
    },
    fetched: void 0,
    floc: false,
...
var metadata_lookup = { "src/routes/__layout.svelte": { "entry": "pages/__layout.svelte-00dff4e8.js", "css": ["assets/pages/__layout.svelte-1dd916ea.css"], "js": ["pages/__layout.svelte-00dff4e8.js", "chunks/vendor-7aaed8c5.js"], "styles": [] }, ".svelte-kit/build/components/error.svelte": { "entry": "error.svelte-f46a7fc1.js", "css": [], "js": ["error.svelte-f46a7fc1.js", "chunks/vendor-7aaed8c5.js"], "styles": [] }, "src/routes/index.svelte": { "entry": "pages/index.svelte-f53b86b6.js", "css": ["assets/pages/index.svelte-2b2b4f73.css", "assets/pagination.min-4d3a60e0.css"], "js": ["pages/index.svelte-f53b86b6.js", "chunks/vendor-7aaed8c5.js"], "styles": [] }, "src/routes/contact.svelte": { "entry": "pages/contact.svelte-fb6d128d.js", "css": ["assets/pages/contact.svelte-4cd1b3be.css"], "js": ["pages/contact.svelte-fb6d128d.js", "chunks/vendor-7aaed8c5.js"], "styles": [] }, "src/routes/about.svelte": { "entry": "pages/about.svelte-d206e57f.js", "css": ["assets/pages/about.svelte-de8cddf4.css", "assets/pagination.min-4d3a60e0.css"], "js": ["pages/about.svelte-d206e57f.js", "chunks/vendor-7aaed8c5.js"], "styles": [] }, "src/routes/blog.svelte": { "entry": "pages/blog.svelte-67fe1a4c.js", "css": ["assets/pages/blog.svelte-cc5d0f05.css"], "js": ["pages/blog.svelte-67fe1a4c.js", "chunks/vendor-7aaed8c5.js"], "styles": [] }, "src/routes/plus.svelte": { "entry": "pages/plus.svelte-570b7cef.js", "css": ["assets/pages/plus.svelte-67719f8d.css"], "js": ["pages/plus.svelte-570b7cef.js", "chunks/vendor-7aaed8c5.js"], "styles": [] }, "src/routes/test.svelte": { "entry": "pages/test.svelte-123f3472.js", "css": ["assets/pages/test.svelte-6e2f192b.css"], "js": ["pages/test.svelte-123f3472.js", "chunks/vendor-7aaed8c5.js"], "styles": [] }, "src/routes/work.svelte": { "entry": "pages/work.svelte-11ac96e9.js", "css": ["assets/pages/work.svelte-3ec902ff.css"], "js": ["pages/work.svelte-11ac96e9.js", "chunks/vendor-7aaed8c5.js"], "styles": [] }, "src/routes/try.svelte": { "entry": "pages/try.svelte-5c3d440a.js", "css": ["assets/pages/try.svelte-11399192.css"], "js": ["pages/try.svelte-5c3d440a.js", "chunks/vendor-7aaed8c5.js"], "styles": [] } };
...
<div class="${"content-500 svelte-1l7560q"}"><h1>Our business is making yours look good.</h1>
  <p class="${"svelte-1l7560q"}">We provide brand centred graphic design and web development services to SMEs
    and corporates in Nairobi.
  </p></div>

<div class="${"content svelte-1l7560q"}">${validate_component(Swiper, "Swiper").$$render($$result, {
    slidesPerView: 3,
    spaceBetween: 10,
    slidesPerGroup: 1,
    mousewheel: false,
    ...
    default: () => `${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/recent/8.jpg"}" alt="${""}" class="${"svelte-1l7560q"}">`
    })}
    ${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/recent/11.jpg"}" alt="${""}" class="${"svelte-1l7560q"}">`
    })}
    ${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/recent/9.jpg"}" alt="${""}" class="${"svelte-1l7560q"}">`
    })}
    ${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/recent/eaglehr-banners.jpg"}" alt="${""}" class="${"svelte-1l7560q"}">`
    })}
    ${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/recent/55.jpg"}" alt="${""}" class="${"svelte-1l7560q"}">`
    })}
    ${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/recent/6.jpg"}" alt="${""}" class="${"svelte-1l7560q"}">`
    })}
    ${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/recent/liberte.jpg"}" alt="${""}" class="${"svelte-1l7560q"}">`
    })}`
  })}</div>

<div class="${"services svelte-1l7560q"}"><h2>Our services</h2>
  <div class="${"accordion top-margin svelte-1l7560q"}">${each$1(Object.entries(data), (entry) => `<div class="${"accordion-entry svelte-1l7560q"}">${validate_component(Accordion, "Accordion").$$render($$result, { entry }, {}, {})}
      </div>`)}</div></div>

<div class="${"recent svelte-1l7560q"}"><h2>Sample projects</h2>
  <p class="${"top-margin svelte-1l7560q"}">We handle many full brand development projects. Below we showcase the ones
    we completed recently
  </p></div>

<div class="${"four-way-grid svelte-1l7560q"}">${validate_component(Recent, "Recent").$$render($$result, {}, {}, {})}</div>

<div class="${"clients svelte-1l7560q"}"><h2>Our clients</h2>
  <p class="${"top-margin svelte-1l7560q"}">We work with companies of all sizes. Start-ups, SMES or corporates.
    Regardless of your size our goal is always the same, do work that helps you
    stand out in the market place.
  </p></div>

<div class="${"logos svelte-1l7560q"}">${validate_component(Swiper, "Swiper").$$render($$result, {
    slidesPerView: 3,
    spaceBetween: 20,
    slidesPerGroup: 1,
    mousewheel: false,
    ...
    default: () => `${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/logos/amsco.png"}" alt="${"amsco logo"}" class="${"svelte-1l7560q"}">`
    })}
    
    ${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/logos/anchor.png"}" alt="${"Anchor builders logo"}" class="${"svelte-1l7560q"}">`
    })}
    ${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/logos/strathmore.png"}" alt="${"Strathmore University logo"}" class="${"svelte-1l7560q"}">`
    })}
    ${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/logos/eaglehr.png"}" alt="${"Eaglehr kenya logo"}" class="${"svelte-1l7560q"}">`
    })}
    ${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/logos/absa.png"}" alt="${"absa bank logo"}" class="${"svelte-1l7560q"}">`
    })}
    ${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/logos/farmhouse.png"}" alt="${"farmhouse sacco logo"}" class="${"svelte-1l7560q"}">`
    })}`
  })}
</div>`;
});
...
<div class="${"width work-wrapper svelte-1e8njfd"}"><div class="${"recent-work"}"><section class="${"two-way-grid"}">${validate_component(TwoWayGrid, "TwoWayGrid").$$render($$result, {}, {}, {
    right: () => `<div slot="${"right"}" class="${"img-wrapper svelte-1e8njfd"}"><img src="${"img/recent/anchor-helmet.jpg"}" alt="${"anchor helmet"}" class="${"svelte-1e8njfd"}"></div>`,
