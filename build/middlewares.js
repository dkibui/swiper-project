...
function init(settings = default_settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: assets + "/_app/start-bb91fb5a.js",
      css: [assets + "/_app/assets/start-61d1577b.css"],
      js: [assets + "/_app/start-bb91fb5a.js", assets + "/_app/chunks/vendor-7aaed8c5.js"]
    },
    fetched: void 0,
    floc: false,
...
<div class="${"container svelte-jvbg5q"}"><section class="${"twofronefr svelte-jvbg5q"}"><div class="${"svelte-jvbg5q"}"><img src="${"img/recent/anchor.png"}" alt="${"anchor logo"}" class="${"svelte-jvbg5q"}"></div>
