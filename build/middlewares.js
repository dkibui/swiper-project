...
function init(settings = default_settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: assets + "/_app/start-6b06f275.js",
      css: [assets + "/_app/assets/start-61d1577b.css"],
      js: [assets + "/_app/start-6b06f275.js", assets + "/_app/chunks/vendor-336043de.js"]
    },
    fetched: void 0,
    floc: false,
...
var css$7 = {
  code: "main.svelte-12ysfir.svelte-12ysfir{flex:1;display:flex;flex-direction:column;width:90%;margin:0 auto;box-sizing:border-box}footer.svelte-12ysfir.svelte-12ysfir{display:flex;flex-direction:column;justify-content:center;align-items:center;padding-top:4rem}footer.svelte-12ysfir a.svelte-12ysfir{font-weight:bold;text-decoration:none}footer.svelte-12ysfir p.svelte-12ysfir{width:90%;max-width:1024px;margin:0 auto}.social-icons.svelte-12ysfir.svelte-12ysfir{display:flex;margin:2.75rem 0 2.5rem 0;gap:1rem}.social-icons.svelte-12ysfir img.svelte-12ysfir{display:block;width:100%;max-width:28px}@media(min-width: 480px){}",
...
<main class="${"svelte-12ysfir"}">${slots.default ? slots.default({}) : ``}</main>

<footer class="${"svelte-12ysfir"}"><p class="${"svelte-12ysfir"}">Thank you for visiting. <a href="${"mailto:dkibui@visign.co.ke"}" class="${"svelte-12ysfir"}">Send us an email
    </a>
    to see how we can help.
  </p>
  <div class="${"social-icons svelte-12ysfir"}"><a href="${"https://www.behance.net"}" class="${"svelte-12ysfir"}"><img src="${"img/social/behance.png"}" alt="${"behance logo"}" class="${"svelte-12ysfir"}"></a>
    <a href="${"https://www.instagram.com"}" class="${"svelte-12ysfir"}"><img src="${"img/social/instagram.png"}" alt="${"instagram logo"}" class="${"svelte-12ysfir"}"></a>
    <a href="${"https://www.twitter.com"}" class="${"svelte-12ysfir"}"><img src="${"img/social/twitter.png"}" alt="${"twitter logo"}" class="${"svelte-12ysfir"}"></a></div>
</footer>`;
});
