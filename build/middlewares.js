...
function init(settings = default_settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: assets + "/_app/start-d6e48153.js",
      css: [assets + "/_app/assets/start-61d1577b.css"],
      js: [assets + "/_app/start-d6e48153.js", assets + "/_app/chunks/vendor-7aaed8c5.js"]
    },
    fetched: void 0,
    floc: false,
...
var metadata_lookup = { "src/routes/__layout.svelte": { "entry": "pages/__layout.svelte-00dff4e8.js", "css": ["assets/pages/__layout.svelte-237f132d.css"], "js": ["pages/__layout.svelte-00dff4e8.js", "chunks/vendor-7aaed8c5.js"], "styles": [] }, ".svelte-kit/build/components/error.svelte": { "entry": "error.svelte-f46a7fc1.js", "css": [], "js": ["error.svelte-f46a7fc1.js", "chunks/vendor-7aaed8c5.js"], "styles": [] }, "src/routes/index.svelte": { "entry": "pages/index.svelte-d02ca98c.js", "css": ["assets/pages/index.svelte-065c815e.css", "assets/pagination.min-4d3a60e0.css"], "js": ["pages/index.svelte-d02ca98c.js", "chunks/vendor-7aaed8c5.js"], "styles": [] }, "src/routes/contact.svelte": { "entry": "pages/contact.svelte-fb6d128d.js", "css": ["assets/pages/contact.svelte-4cd1b3be.css"], "js": ["pages/contact.svelte-fb6d128d.js", "chunks/vendor-7aaed8c5.js"], "styles": [] }, "src/routes/about.svelte": { "entry": "pages/about.svelte-d206e57f.js", "css": ["assets/pages/about.svelte-de8cddf4.css", "assets/pagination.min-4d3a60e0.css"], "js": ["pages/about.svelte-d206e57f.js", "chunks/vendor-7aaed8c5.js"], "styles": [] }, "src/routes/blog.svelte": { "entry": "pages/blog.svelte-67fe1a4c.js", "css": ["assets/pages/blog.svelte-cc5d0f05.css"], "js": ["pages/blog.svelte-67fe1a4c.js", "chunks/vendor-7aaed8c5.js"], "styles": [] }, "src/routes/plus.svelte": { "entry": "pages/plus.svelte-570b7cef.js", "css": ["assets/pages/plus.svelte-67719f8d.css"], "js": ["pages/plus.svelte-570b7cef.js", "chunks/vendor-7aaed8c5.js"], "styles": [] }, "src/routes/test.svelte": { "entry": "pages/test.svelte-123f3472.js", "css": ["assets/pages/test.svelte-6e2f192b.css"], "js": ["pages/test.svelte-123f3472.js", "chunks/vendor-7aaed8c5.js"], "styles": [] }, "src/routes/work.svelte": { "entry": "pages/work.svelte-77c095ac.js", "css": ["assets/pages/work.svelte-4b0ee345.css"], "js": ["pages/work.svelte-77c095ac.js", "chunks/vendor-7aaed8c5.js"], "styles": [] }, "src/routes/try.svelte": { "entry": "pages/try.svelte-5c3d440a.js", "css": ["assets/pages/try.svelte-11399192.css"], "js": ["pages/try.svelte-5c3d440a.js", "chunks/vendor-7aaed8c5.js"], "styles": [] } };
...
<div class="${"content svelte-16ylcdu"}">${validate_component(Swiper, "Swiper").$$render($$result, {
    ...
    default: () => `${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/recent/anchor-cap.jpg"}" alt="${""}" class="${"svelte-16ylcdu"}">`
    })}
    ${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/recent/carrier bags.jpg"}" alt="${""}" class="${"svelte-16ylcdu"}">`
    })}
    ${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/recent/9.jpg"}" alt="${""}" class="${"svelte-16ylcdu"}">`
    })}
    ${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/recent/hanging-banner.jpg"}" alt="${""}" class="${"svelte-16ylcdu"}">`
    })}
    ${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/recent/5.jpg"}" alt="${""}" class="${"svelte-16ylcdu"}">`
    })}
    ${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/recent/anchor-advert.jpg"}" alt="${""}" class="${"svelte-16ylcdu"}">`
    })}`
  })}
</div>`;
});
...
<div class="${"content-500 svelte-1yti2h4"}"><h1>Anchor homes branding</h1>
  <p class="${"svelte-1yti2h4"}">Anchor approached us to imagine their branding. For this project we wanted
    to create a brand that is emotional and caring. A brand that lets you know
    we&#39;ve got your back.
  </p>
  </div>

<article class="${"width bg-color img-width hero svelte-1yti2h4"}"><div class="${"svelte-1yti2h4"}"><img src="${"img/recent/anchor hero.png"}" alt="${"anchor"}" class="${"svelte-1yti2h4"}"></div></article>

<div class="${"intersection width svelte-1yti2h4"}"><h2 class="${"svelte-1yti2h4"}">Our identity</h2>
  <p class="${"svelte-1yti2h4"}">To establish Anchor&#39;s identity we, we selected brand colours and fonts. We
    created brand patterns and established guides on how to use the logo, images
    and colours. Put together these elements create a unique and recognisable
    brand.
  </p></div>

<div class="${"width work-wrapper svelte-1yti2h4"}"><div class="${"recent-work"}"><section class="${"two-way-grid"}">${validate_component(TwoWayGrid, "TwoWayGrid").$$render($$result, {}, {}, {
    right: () => `<div slot="${"right"}" class="${"img-wrapper svelte-1yti2h4"}"><img src="${"img/recent/1.jpg"}" alt="${"eaglehr"}" class="${"svelte-1yti2h4"}"></div>`,
    left: () => `<div slot="${"left"}" class="${"img-wrapper svelte-1yti2h4"}"><img src="${"img/recent/2.jpg"}" alt="${"eaglehr"}" class="${"svelte-1yti2h4"}"></div>`
  })}</section></div></div>

<div class="${"width work-wrapper svelte-1yti2h4"}"><div class="${"recent-work"}"><section class="${"two-way-grid"}">${validate_component(TwoWayGrid, "TwoWayGrid").$$render($$result, {}, {}, {
    right: () => `<div slot="${"right"}" class="${"img-wrapper svelte-1yti2h4"}"><img src="${"img/recent/anchor-advert.jpg"}" alt="${"anchor construction advert"}" class="${"svelte-1yti2h4"}"></div>`,
    left: () => `<div slot="${"left"}" class="${"img-wrapper svelte-1yti2h4"}"><img src="${"img/recent/anchor-elements.jpg"}" alt="${"anchor"}" class="${"svelte-1yti2h4"}"></div>`
  })}</section></div></div>

<div class="${"intersection width svelte-1yti2h4"}"><h2 class="${"svelte-1yti2h4"}">Identity and application</h2>
  <p class="${"svelte-1yti2h4"}">Anchor&#39;s logo is versatile and adaptable in it&#39;s application. It works well
    in various forms of marketing communication.
  </p></div>

<div class="${"bg-white width svelte-1yti2h4"}"><img src="${"img/recent/branded.jpg"}" alt="${"anchor one"}" class="${"svelte-1yti2h4"}"></div>

<div class="${"width img-width three-way-grid svelte-1yti2h4"}">${validate_component(ThreeWayGrid, "ThreeWayGrid").$$render($$result, {}, {}, {
    right: () => `<img slot="${"right"}" src="${"img/recent/7.jpg"}" alt="${"anchor tshirt branding"}" class="${"svelte-1yti2h4"}">`,
    center: () => `<img slot="${"center"}" src="${"img/recent/anchor-cap.jpg"}" alt="${"anchor one"}" class="${"svelte-1yti2h4"}">`,
    left: () => `<img slot="${"left"}" src="${"img/recent/carrier bags.jpg"}" alt="${"anchor one"}" class="${"svelte-1yti2h4"}">`
  })}</div>

<div class="${"width work-wrapper svelte-1yti2h4"}"><div class="${"recent-work"}"><section class="${"two-way-grid"}">${validate_component(TwoWayGrid, "TwoWayGrid").$$render($$result, {}, {}, {
    right: () => `<div slot="${"right"}" class="${"img-wrapper svelte-1yti2h4"}"><img src="${"img/recent/anchor-helmet.jpg"}" alt="${"anchor helmet"}" class="${"svelte-1yti2h4"}"></div>`,
    left: () => `<div slot="${"left"}" class="${"img-wrapper svelte-1yti2h4"}"><img src="${"img/recent/hanging-banner.jpg"}" alt="${"anchor hanging banner"}" class="${"svelte-1yti2h4"}"></div>`
  })}</section></div>
</div>`;
});
