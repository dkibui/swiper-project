...
function init(settings = default_settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: assets + "/_app/start-3432ecdd.js",
      css: [assets + "/_app/assets/start-61d1577b.css"],
      js: [assets + "/_app/start-3432ecdd.js", assets + "/_app/chunks/vendor-a533b0b9.js"]
    },
    fetched: void 0,
    floc: false,
...
<div class="${"intersection width svelte-1gitznl"}"><h2 class="${"svelte-1gitznl"}">Anchor identity</h2>
...
<div class="${"intersection width svelte-1gitznl"}"><h2 class="${"svelte-1gitznl"}">Identity application</h2>
