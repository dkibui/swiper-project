...
function init(settings = default_settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: assets + "/_app/start-d63d400f.js",
      css: [assets + "/_app/assets/start-61d1577b.css"],
      js: [assets + "/_app/start-d63d400f.js", assets + "/_app/chunks/vendor-7aaed8c5.js"]
    },
    fetched: void 0,
    floc: false,
...
<div class="${"content-500 svelte-tje1k9"}"><h1>Our business is making yours look good</h1>
  <p class="${"svelte-tje1k9"}">We provide brand centric graphic design and web development services to
    businesses in East Africa.
  </p></div>

<div class="${"content svelte-tje1k9"}">${validate_component(Swiper, "Swiper").$$render($$result, {
    slidesPerView: 3,
    spaceBetween: 10,
    slidesPerGroup: 1,
    mousewheel: false,
    ...
    default: () => `${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/recent/amsco.jpg"}" alt="${"amsco"}" class="${"svelte-tje1k9"}">`
    })}
    ${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/recent/8.jpg"}" alt="${""}" class="${"svelte-tje1k9"}">`
    })}
    ${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/recent/11.jpg"}" alt="${""}" class="${"svelte-tje1k9"}">`
    })}
    ${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/recent/9.jpg"}" alt="${""}" class="${"svelte-tje1k9"}">`
    })}
    ${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/recent/strathmore-3.jpg"}" alt="${"strathmore"}" class="${"svelte-tje1k9"}">`
    })}
    ${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/recent/6.jpg"}" alt="${""}" class="${"svelte-tje1k9"}">`
    })}
    ${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/recent/liberte.jpg"}" alt="${""}" class="${"svelte-tje1k9"}">`
    })}`
  })}</div>

<div class="${"services svelte-tje1k9"}"><h2>Our services</h2>
  <div class="${"accordion top-margin svelte-tje1k9"}">${each$1(Object.entries(data), (entry) => `<div class="${"accordion-entry svelte-tje1k9"}">${validate_component(Accordion, "Accordion").$$render($$result, { entry }, {}, {})}
      </div>`)}</div></div>

<div class="${"recent svelte-tje1k9"}"><h2>Sample projects</h2>
  <p class="${"top-margin svelte-tje1k9"}">We handle many full brand development projects. Below we showcase the ones
    we completed recently
  </p></div>

<div class="${"four-way-grid svelte-tje1k9"}">${validate_component(Recent, "Recent").$$render($$result, {}, {}, {})}</div>

<div class="${"clients svelte-tje1k9"}"><h2>Our clients</h2>
  <p class="${"top-margin svelte-tje1k9"}">We work with companies of all sizes. Start-ups, SMES or corporates.
    Regardless of your size our goal is always the same, do work that helps you
    stand out in the market place.
  </p></div>

<div class="${"logos svelte-tje1k9"}">${validate_component(Swiper, "Swiper").$$render($$result, {
    slidesPerView: 3,
    spaceBetween: 20,
    slidesPerGroup: 1,
    mousewheel: false,
    ...
    default: () => `${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/logos/amsco.png"}" alt="${"amsco logo"}" class="${"svelte-tje1k9"}">`
    })}
    
    ${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/logos/anchor.png"}" alt="${"Anchor builders logo"}" class="${"svelte-tje1k9"}">`
    })}
    ${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/logos/strathmore.png"}" alt="${"Strathmore University logo"}" class="${"svelte-tje1k9"}">`
    })}
    ${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/logos/eaglehr.png"}" alt="${"Eaglehr kenya logo"}" class="${"svelte-tje1k9"}">`
    })}
    ${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/logos/absa.png"}" alt="${"absa bank logo"}" class="${"svelte-tje1k9"}">`
    })}
    ${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/logos/farmhouse.png"}" alt="${"farmhouse sacco logo"}" class="${"svelte-tje1k9"}">`
    })}`
  })}
</div>`;
});
