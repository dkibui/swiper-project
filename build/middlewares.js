...
function init(settings = default_settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: assets + "/_app/start-7f6f375b.js",
      css: [assets + "/_app/assets/start-61d1577b.css"],
      js: [assets + "/_app/start-7f6f375b.js", assets + "/_app/chunks/vendor-336043de.js"]
    },
    fetched: void 0,
    floc: false,
...
var css$8 = {
  code: ".menu.svelte-1bewzfb.svelte-1bewzfb{width:94%;margin:0 auto;display:flex;align-items:center;justify-content:space-between;margin-top:0.725rem}.menu.svelte-1bewzfb img.svelte-1bewzfb{display:block;height:36px}.container.svelte-1bewzfb.svelte-1bewzfb{cursor:pointer}.bar1.svelte-1bewzfb.svelte-1bewzfb,.bar2.svelte-1bewzfb.svelte-1bewzfb,.bar3.svelte-1bewzfb.svelte-1bewzfb{width:32px;height:3px;background-color:var(--text-color);margin:8px 0;transition:0.4s}.change.svelte-1bewzfb .bar1.svelte-1bewzfb{-webkit-transform:rotate(-45deg) translate(-9px, 6px);transform:rotate(-45deg) translate(-9px, 6px)}.change.svelte-1bewzfb .bar2.svelte-1bewzfb{opacity:0}.change.svelte-1bewzfb .bar3.svelte-1bewzfb{-webkit-transform:rotate(45deg) translate(-8px, -8px);transform:rotate(45deg) translate(-8px, -8px)}.sidenav.svelte-1bewzfb.svelte-1bewzfb{height:100%;width:0;position:fixed;z-index:9;top:0;left:0;background-color:var(--primary-color);opacity:0.98999;overflow-x:hidden;padding-top:60px;transition:0.5s}.sidenav.svelte-1bewzfb a.svelte-1bewzfb{padding:28px 8px 28px 32px;text-decoration:none;font-size:20px;color:var(--text-color);display:block;transition:0.3s;border-bottom:1px solid var(--secondary-color)}.sidenav.svelte-1bewzfb a.svelte-1bewzfb:first-child{padding-top:19px}.sidenav.svelte-1bewzfb a.svelte-1bewzfb:first-child,.sidenav.svelte-1bewzfb a.svelte-1bewzfb:last-child{border-bottom:none}.sidenav.svelte-1bewzfb a.svelte-1bewzfb:hover{color:#f1f1f1;color:var(--accent-color)}.sidenav.svelte-1bewzfb .closebtn.svelte-1bewzfb{position:absolute;top:0;right:25px;font-size:36px;margin-left:50px}.open.svelte-1bewzfb.svelte-1bewzfb{width:70%}@media(min-width: 768px){.container.svelte-1bewzfb.svelte-1bewzfb{display:none}.navigation.svelte-1bewzfb.svelte-1bewzfb{width:90%;max-width:1600px;margin:auto;display:flex;justify-content:space-between;align-items:center;position:relative;height:fit-content;margin-top:0.75rem}.menu.svelte-1bewzfb.svelte-1bewzfb{margin:0}.sidenav.svelte-1bewzfb.svelte-1bewzfb{display:flex;height:100%;width:100%;position:static;background-color:transparent;overflow-x:hidden;padding-top:0;transition:0s;justify-content:flex-end}.sidenav.svelte-1bewzfb a.svelte-1bewzfb{font-size:18px}.sidenav.svelte-1bewzfb a.svelte-1bewzfb:first-child{display:none}.sidenav.svelte-1bewzfb a.svelte-1bewzfb{margin:0;padding:0;padding-left:2.4rem}.sidenav.svelte-1bewzfb .closebtn.svelte-1bewzfb{position:static;top:0;right:0;font-size:36px;margin-left:0}}",
  map: `{"version":3,"file":"Canvas.svelte","sources":["Canvas.svelte"],"sourcesContent":["<script>\\n  let navOpen = false\\n\\n  function handleNav() {\\n    navOpen = !navOpen\\n  }\\n\\n  function handleNavWithKey(e) {\\n    console.log(e.code)\\n    if (e.code === 'F1') {\\n      navOpen = !navOpen\\n    }\\n  }\\n<\/script>\\n\\n<div class=\\"navigation\\">\\n  <div class=\\"menu\\">\\n    <div class=\\"logo\\">\\n      <a href=\\"/\\"><img src=\\"img/visign-logo.svg\\" alt=\\"visign kenya logo\\" /></a>\\n    </div>\\n    <div class=\\"container\\" class:change={navOpen} on:click={handleNav}>\\n      <div class=\\"bar1\\" />\\n      <div class=\\"bar2\\" />\\n      <div class=\\"bar3\\" />\\n    </div>\\n  </div>\\n\\n  <div id=\\"mySidenav\\" class=\\"sidenav\\" class:open={navOpen}>\\n    <a href=\\"#a\\" class=\\"closebtn\\" on:click={handleNav}>&times;</a>\\n    <a href=\\"/\\" on:click={handleNav}>Home</a>\\n    <a href=\\"/about\\" on:click={handleNav}>About</a>\\n    <a href=\\"/work\\" on:click={handleNav}>Work</a>\\n    <!-- <a href=\\"/blog\\" on:click={handleNav}>Blog</a> -->\\n    <!-- <a href=\\"/contact\\" on:click={handleNav}>Contact</a> -->\\n  </div>\\n</div>\\n\\n<style>\\n  .menu {\\n    width: 94%;\\n    margin: 0 auto;\\n    display: flex;\\n    align-items: center;\\n    justify-content: space-between;\\n    margin-top: 0.725rem;\\n  }\\n\\n  .menu img {\\n    display: block;\\n    height: 36px;\\n  }\\n\\n  /* Hamburger Menu icon */\\n  .container {\\n    cursor: pointer;\\n  }\\n\\n  .bar1,\\n  .bar2,\\n  .bar3 {\\n    width: 32px;\\n    height: 3px;\\n    background-color: var(--text-color);\\n    margin: 8px 0;\\n    transition: 0.4s;\\n  }\\n\\n  .change .bar1 {\\n    -webkit-transform: rotate(-45deg) translate(-9px, 6px);\\n    transform: rotate(-45deg) translate(-9px, 6px);\\n  }\\n\\n  .change .bar2 {\\n    opacity: 0;\\n  }\\n\\n  .change .bar3 {\\n    -webkit-transform: rotate(45deg) translate(-8px, -8px);\\n    transform: rotate(45deg) translate(-8px, -8px);\\n  }\\n\\n  /* The side navigation menu */\\n  .sidenav {\\n    height: 100%;\\n    width: 0; /* 0 width - change this with JavaScript */\\n    position: fixed;\\n    z-index: 9;\\n    top: 0;\\n    left: 0;\\n    background-color: var(--primary-color);\\n    opacity: 0.98999;\\n    overflow-x: hidden; /* Disable horizontal scroll */\\n    padding-top: 60px;\\n    transition: 0.5s;\\n  }\\n\\n  /* The navigation menu links */\\n  .sidenav a {\\n    padding: 28px 8px 28px 32px;\\n    text-decoration: none;\\n    font-size: 20px;\\n    color: var(--text-color);\\n    display: block;\\n    transition: 0.3s;\\n    border-bottom: 1px solid var(--secondary-color);\\n  }\\n\\n  .sidenav a:first-child {\\n    padding-top: 19px;\\n  }\\n\\n  .sidenav a:first-child,\\n  .sidenav a:last-child {\\n    border-bottom: none;\\n  }\\n\\n  /* When you mouse over the navigation links, change their color */\\n  .sidenav a:hover {\\n    color: #f1f1f1;\\n    color: var(--accent-color);\\n  }\\n\\n  /* Position and style the close button (top right corner) */\\n  .sidenav .closebtn {\\n    position: absolute;\\n    top: 0;\\n    right: 25px;\\n    font-size: 36px;\\n    margin-left: 50px;\\n  }\\n\\n  .open {\\n    width: 70%;\\n  }\\n\\n  /* On smaller screens, where height is less than 450px, change the style of the sidenav (less padding and a smaller font size) */\\n  @media (min-width: 768px) {\\n    .container {\\n      display: none;\\n    }\\n\\n    .navigation {\\n      width: 90%;\\n      max-width: 1600px;\\n      margin: auto;\\n      display: flex;\\n      justify-content: space-between;\\n      align-items: center;\\n      position: relative;\\n      height: fit-content;\\n      /* border: 1px solid rgb(41, 41, 41); */\\n      margin-top: 0.75rem;\\n    }\\n\\n    .menu {\\n      margin: 0;\\n    }\\n\\n    .sidenav {\\n      display: flex;\\n      height: 100%;\\n      width: 100%; /* 0 width - change this with JavaScript */\\n      position: static;\\n      background-color: transparent;\\n      overflow-x: hidden; /* Disable horizontal scroll */\\n      padding-top: 0;\\n      transition: 0s;\\n      justify-content: flex-end;\\n    }\\n\\n    .sidenav a {\\n      font-size: 18px;\\n    }\\n\\n    .sidenav a:first-child {\\n      display: none;\\n    }\\n\\n    .sidenav a {\\n      margin: 0;\\n      padding: 0;\\n      padding-left: 2.4rem;\\n    }\\n\\n    .sidenav .closebtn {\\n      position: static;\\n      top: 0;\\n      right: 0;\\n      font-size: 36px;\\n      margin-left: 0;\\n    }\\n  }\\n</style>\\n"],"names":[],"mappings":"AAsCE,KAAK,8BAAC,CAAC,AACL,KAAK,CAAE,GAAG,CACV,MAAM,CAAE,CAAC,CAAC,IAAI,CACd,OAAO,CAAE,IAAI,CACb,WAAW,CAAE,MAAM,CACnB,eAAe,CAAE,aAAa,CAC9B,UAAU,CAAE,QAAQ,AACtB,CAAC,AAED,oBAAK,CAAC,GAAG,eAAC,CAAC,AACT,OAAO,CAAE,KAAK,CACd,MAAM,CAAE,IAAI,AACd,CAAC,AAGD,UAAU,8BAAC,CAAC,AACV,MAAM,CAAE,OAAO,AACjB,CAAC,AAED,mCAAK,CACL,mCAAK,CACL,KAAK,8BAAC,CAAC,AACL,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,GAAG,CACX,gBAAgB,CAAE,IAAI,YAAY,CAAC,CACnC,MAAM,CAAE,GAAG,CAAC,CAAC,CACb,UAAU,CAAE,IAAI,AAClB,CAAC,AAED,sBAAO,CAAC,KAAK,eAAC,CAAC,AACb,iBAAiB,CAAE,OAAO,MAAM,CAAC,CAAC,UAAU,IAAI,CAAC,CAAC,GAAG,CAAC,CACtD,SAAS,CAAE,OAAO,MAAM,CAAC,CAAC,UAAU,IAAI,CAAC,CAAC,GAAG,CAAC,AAChD,CAAC,AAED,sBAAO,CAAC,KAAK,eAAC,CAAC,AACb,OAAO,CAAE,CAAC,AACZ,CAAC,AAED,sBAAO,CAAC,KAAK,eAAC,CAAC,AACb,iBAAiB,CAAE,OAAO,KAAK,CAAC,CAAC,UAAU,IAAI,CAAC,CAAC,IAAI,CAAC,CACtD,SAAS,CAAE,OAAO,KAAK,CAAC,CAAC,UAAU,IAAI,CAAC,CAAC,IAAI,CAAC,AAChD,CAAC,AAGD,QAAQ,8BAAC,CAAC,AACR,MAAM,CAAE,IAAI,CACZ,KAAK,CAAE,CAAC,CACR,QAAQ,CAAE,KAAK,CACf,OAAO,CAAE,CAAC,CACV,GAAG,CAAE,CAAC,CACN,IAAI,CAAE,CAAC,CACP,gBAAgB,CAAE,IAAI,eAAe,CAAC,CACtC,OAAO,CAAE,OAAO,CAChB,UAAU,CAAE,MAAM,CAClB,WAAW,CAAE,IAAI,CACjB,UAAU,CAAE,IAAI,AAClB,CAAC,AAGD,uBAAQ,CAAC,CAAC,eAAC,CAAC,AACV,OAAO,CAAE,IAAI,CAAC,GAAG,CAAC,IAAI,CAAC,IAAI,CAC3B,eAAe,CAAE,IAAI,CACrB,SAAS,CAAE,IAAI,CACf,KAAK,CAAE,IAAI,YAAY,CAAC,CACxB,OAAO,CAAE,KAAK,CACd,UAAU,CAAE,IAAI,CAChB,aAAa,CAAE,GAAG,CAAC,KAAK,CAAC,IAAI,iBAAiB,CAAC,AACjD,CAAC,AAED,uBAAQ,CAAC,gBAAC,YAAY,AAAC,CAAC,AACtB,WAAW,CAAE,IAAI,AACnB,CAAC,AAED,uBAAQ,CAAC,gBAAC,YAAY,CACtB,uBAAQ,CAAC,gBAAC,WAAW,AAAC,CAAC,AACrB,aAAa,CAAE,IAAI,AACrB,CAAC,AAGD,uBAAQ,CAAC,gBAAC,MAAM,AAAC,CAAC,AAChB,KAAK,CAAE,OAAO,CACd,KAAK,CAAE,IAAI,cAAc,CAAC,AAC5B,CAAC,AAGD,uBAAQ,CAAC,SAAS,eAAC,CAAC,AAClB,QAAQ,CAAE,QAAQ,CAClB,GAAG,CAAE,CAAC,CACN,KAAK,CAAE,IAAI,CACX,SAAS,CAAE,IAAI,CACf,WAAW,CAAE,IAAI,AACnB,CAAC,AAED,KAAK,8BAAC,CAAC,AACL,KAAK,CAAE,GAAG,AACZ,CAAC,AAGD,MAAM,AAAC,YAAY,KAAK,CAAC,AAAC,CAAC,AACzB,UAAU,8BAAC,CAAC,AACV,OAAO,CAAE,IAAI,AACf,CAAC,AAED,WAAW,8BAAC,CAAC,AACX,KAAK,CAAE,GAAG,CACV,SAAS,CAAE,MAAM,CACjB,MAAM,CAAE,IAAI,CACZ,OAAO,CAAE,IAAI,CACb,eAAe,CAAE,aAAa,CAC9B,WAAW,CAAE,MAAM,CACnB,QAAQ,CAAE,QAAQ,CAClB,MAAM,CAAE,WAAW,CAEnB,UAAU,CAAE,OAAO,AACrB,CAAC,AAED,KAAK,8BAAC,CAAC,AACL,MAAM,CAAE,CAAC,AACX,CAAC,AAED,QAAQ,8BAAC,CAAC,AACR,OAAO,CAAE,IAAI,CACb,MAAM,CAAE,IAAI,CACZ,KAAK,CAAE,IAAI,CACX,QAAQ,CAAE,MAAM,CAChB,gBAAgB,CAAE,WAAW,CAC7B,UAAU,CAAE,MAAM,CAClB,WAAW,CAAE,CAAC,CACd,UAAU,CAAE,EAAE,CACd,eAAe,CAAE,QAAQ,AAC3B,CAAC,AAED,uBAAQ,CAAC,CAAC,eAAC,CAAC,AACV,SAAS,CAAE,IAAI,AACjB,CAAC,AAED,uBAAQ,CAAC,gBAAC,YAAY,AAAC,CAAC,AACtB,OAAO,CAAE,IAAI,AACf,CAAC,AAED,uBAAQ,CAAC,CAAC,eAAC,CAAC,AACV,MAAM,CAAE,CAAC,CACT,OAAO,CAAE,CAAC,CACV,YAAY,CAAE,MAAM,AACtB,CAAC,AAED,uBAAQ,CAAC,SAAS,eAAC,CAAC,AAClB,QAAQ,CAAE,MAAM,CAChB,GAAG,CAAE,CAAC,CACN,KAAK,CAAE,CAAC,CACR,SAAS,CAAE,IAAI,CACf,WAAW,CAAE,CAAC,AAChB,CAAC,AACH,CAAC"}`
};
var Canvas = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css$8);
  return `<div class="${"navigation svelte-1bewzfb"}"><div class="${"menu svelte-1bewzfb"}"><div class="${"logo"}"><a href="${"/"}"><img src="${"img/visign-logo.svg"}" alt="${"visign kenya logo"}" class="${"svelte-1bewzfb"}"></a></div>
    <div class="${["container svelte-1bewzfb", ""].join(" ").trim()}"><div class="${"bar1 svelte-1bewzfb"}"></div>
      <div class="${"bar2 svelte-1bewzfb"}"></div>
      <div class="${"bar3 svelte-1bewzfb"}"></div></div></div>

  <div id="${"mySidenav"}" class="${["sidenav svelte-1bewzfb", ""].join(" ").trim()}"><a href="${"#a"}" class="${"closebtn svelte-1bewzfb"}">\xD7</a>
    <a href="${"/"}" class="${"svelte-1bewzfb"}">Home</a>
    <a href="${"/about"}" class="${"svelte-1bewzfb"}">About</a>
    <a href="${"/work"}" class="${"svelte-1bewzfb"}">Work</a>
    
    </div>
</div>`;
});
var css$7 = {
  code: "main.svelte-1e3k7tn.svelte-1e3k7tn{flex:1;display:flex;flex-direction:column;width:87%;margin:0 auto;box-sizing:border-box}footer.svelte-1e3k7tn.svelte-1e3k7tn{display:flex;flex-direction:column;justify-content:center;align-items:center;padding-top:4rem}footer.svelte-1e3k7tn a.svelte-1e3k7tn{font-weight:bold;text-decoration:none}footer.svelte-1e3k7tn p.svelte-1e3k7tn{width:87%;max-width:1024px;margin:0 auto}.social-icons.svelte-1e3k7tn.svelte-1e3k7tn{display:flex;margin:2.75rem 0 2.5rem 0;gap:1rem}.social-icons.svelte-1e3k7tn img.svelte-1e3k7tn{display:block;width:100%;max-width:28px}@media(min-width: 480px){}",
...
<main class="${"svelte-1e3k7tn"}">${slots.default ? slots.default({}) : ``}</main>

<footer class="${"svelte-1e3k7tn"}"><p class="${"svelte-1e3k7tn"}">Thank you for visiting. <a href="${"mailto:dkibui@visign.co.ke"}" class="${"svelte-1e3k7tn"}">Send us an email
    </a>
    to see how we can help.
  </p>
  <div class="${"social-icons svelte-1e3k7tn"}"><a href="${"https://www.behance.net"}" class="${"svelte-1e3k7tn"}"><img src="${"img/social/behance.png"}" alt="${"behance logo"}" class="${"svelte-1e3k7tn"}"></a>
    <a href="${"https://www.instagram.com"}" class="${"svelte-1e3k7tn"}"><img src="${"img/social/instagram.png"}" alt="${"instagram logo"}" class="${"svelte-1e3k7tn"}"></a>
    <a href="${"https://www.twitter.com"}" class="${"svelte-1e3k7tn"}"><img src="${"img/social/twitter.png"}" alt="${"twitter logo"}" class="${"svelte-1e3k7tn"}"></a></div>
</footer>`;
});
