...
function init(settings = default_settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: assets + "/_app/start-b6b6fe7e.js",
      css: [assets + "/_app/assets/start-61d1577b.css"],
      js: [assets + "/_app/start-b6b6fe7e.js", assets + "/_app/chunks/vendor-2f3453ae.js"]
    },
    fetched: void 0,
    floc: false,
...
var Accordion = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="${"btn svelte-ajfeym"}"${add_attribute("aria-expanded", isOpen, 0)}><p class="${"svelte-ajfeym"}">${escape(entry[0])}</p>
  <svg class="${"svg svelte-ajfeym"}" height="${"17"}" width="${"17"}"><line x1="${"0"}" y1="${"8.5"}" x2="${"17"}" y2="${"8.5"}"></line><line x1="${"8.5"}" y1="${"17"}" x2="${"8.5"}" y2="${"0"}"></line></svg></div>
