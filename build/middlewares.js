...
function init(settings = default_settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: assets + "/_app/start-33625e1b.js",
      css: [assets + "/_app/assets/start-61d1577b.css"],
      js: [assets + "/_app/start-33625e1b.js", assets + "/_app/chunks/vendor-7aaed8c5.js"]
    },
    fetched: void 0,
    floc: false,
...
<div class="${"hero-image svelte-u3ityg"}"><h1>Our design portfolio</h1>
  <p class="${"svelte-u3ityg"}">We had the privilege to work on some amazing design projects over the years.
    Get to see some of our recent design work here.
  </p></div>

<div class="${"container svelte-u3ityg"}"><h2 class="${"svelte-u3ityg"}">Logos</h2>
  <p class="${"svelte-u3ityg"}">Logo is the most visible among your identity elements. No wonder it takes
    the most time when developing a visual brand.
  </p>
  <p class="${"svelte-u3ityg"}">A good logo should be simple in appearance and easy to remember. Visual
    appeal is cool too.
  </p>
  <section class="${"fourwaygrid svelte-u3ityg"}"><div class="${"svelte-u3ityg"}"><img src="${"img/recent/anchor.jpg"}" alt="${"anchor logo"}" class="${"svelte-u3ityg"}"></div>
    <div class="${"svelte-u3ityg"}"><img src="${"img/recent/eaglehr.jpg"}" alt="${"anchor logo"}" class="${"svelte-u3ityg"}"></div>
    <div class="${"svelte-u3ityg"}"><img src="${"img/recent/imexafrica.jpg"}" alt="${"anchor logo"}" class="${"svelte-u3ityg"}"></div>
    <div class="${"svelte-u3ityg"}"><img src="${"img/recent/liberte_project.jpg"}" alt="${"anchor logo"}" class="${"svelte-u3ityg"}"></div></section></div>

<div class="${"container svelte-u3ityg"}"><section class="${"twofronefr svelte-u3ityg"}"><div class="${"twofr svelte-u3ityg"}"><img src="${"img/recent/hoody.jpg"}" alt="${"anchor logo"}" class="${"svelte-u3ityg"}"></div>
    <div class="${"onefr svelte-u3ityg"}"><img src="${"img/recent/giftbags.jpg"}" alt="${"anchor logo"}" class="${"svelte-u3ityg"}"></div></section></div>
<div class="${"container svelte-u3ityg"}"><h2 class="${"svelte-u3ityg"}">Social media posts</h2>
  <p class="${"svelte-u3ityg"}">The importance of social media for marketing has exploded in the last
    decade. We will help you market to your target audience through creative
    posts.
  </p>
  <section class="${"threewaygrid svelte-u3ityg"}"><div class="${"svelte-u3ityg"}"><img src="${"img/recent/liberte.jpg"}" alt="${"anchor logo"}" class="${"svelte-u3ityg"}"></div>
    <div class="${"svelte-u3ityg"}"><img src="${"img/recent/11.jpg"}" alt="${"anchor logo"}" class="${"svelte-u3ityg"}"></div>
    <div class="${"svelte-u3ityg"}"><img src="${"img/recent/6.jpg"}" alt="${"anchor logo"}" class="${"svelte-u3ityg"}"></div></section></div>

<div class="${"container small-margin svelte-u3ityg"}"><div class="${"svelte-u3ityg"}"><img src="${"img/recent/anchor-brand-guidelines.jpg"}" alt="${"anchor brand guidelines"}" class="${"svelte-u3ityg"}"></div></div>
<div class="${"container small-margin svelte-u3ityg"}"><div class="${"svelte-u3ityg"}"><img src="${"img/recent/overview.jpg"}" alt="${"anchor brand guidelines"}" class="${"svelte-u3ityg"}"></div></div>

<div class="${"container svelte-u3ityg"}"><h2 class="${"svelte-u3ityg"}">Branding</h2>
  <p class="${"svelte-u3ityg"}">We specialize in mercherndise design and supply. Merch distribution is a
    marketing gift that keeps giving. Get your merch from us today.
  </p>
  <section class="${"threewaygrid svelte-u3ityg"}"><div class="${"svelte-u3ityg"}"><img src="${"img/recent/carrier bags.jpg"}" alt="${"anchor logo"}" class="${"svelte-u3ityg"}"></div>
    <div class="${"svelte-u3ityg"}"><img src="${"img/recent/9.jpg"}" alt="${"anchor logo"}" class="${"svelte-u3ityg"}"></div>
    <div class="${"svelte-u3ityg"}"><img src="${"img/recent/anchor-cap.jpg"}" alt="${"anchor logo"}" class="${"svelte-u3ityg"}"></div></section>
</div>`;
});
