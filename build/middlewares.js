...
function init(settings = default_settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: assets + "/_app/start-9821f6f9.js",
      css: [assets + "/_app/assets/start-61d1577b.css"],
      js: [assets + "/_app/start-9821f6f9.js", assets + "/_app/chunks/vendor-a533b0b9.js"]
    },
    fetched: void 0,
    floc: false,
...
var metadata_lookup = { "src/routes/__layout.svelte": { "entry": "pages/__layout.svelte-39607c72.js", "css": ["assets/pages/__layout.svelte-c0e401b4.css"], "js": ["pages/__layout.svelte-39607c72.js", "chunks/vendor-a533b0b9.js"], "styles": [] }, ".svelte-kit/build/components/error.svelte": { "entry": "error.svelte-693cbff8.js", "css": [], "js": ["error.svelte-693cbff8.js", "chunks/vendor-a533b0b9.js"], "styles": [] }, "src/routes/index.svelte": { "entry": "pages/index.svelte-d55b509a.js", "css": ["assets/pages/index.svelte-efff73fc.css", "assets/pagination.min-4d3a60e0.css"], "js": ["pages/index.svelte-d55b509a.js", "chunks/vendor-a533b0b9.js"], "styles": [] }, "src/routes/about.svelte": { "entry": "pages/about.svelte-b2f6cb2c.js", "css": ["assets/pages/about.svelte-de8cddf4.css", "assets/pagination.min-4d3a60e0.css"], "js": ["pages/about.svelte-b2f6cb2c.js", "chunks/vendor-a533b0b9.js"], "styles": [] }, "src/routes/plus.svelte": { "entry": "pages/plus.svelte-7c51b06f.js", "css": ["assets/pages/plus.svelte-67719f8d.css"], "js": ["pages/plus.svelte-7c51b06f.js", "chunks/vendor-a533b0b9.js"], "styles": [] }, "src/routes/test.svelte": { "entry": "pages/test.svelte-1250c728.js", "css": ["assets/pages/test.svelte-6e2f192b.css"], "js": ["pages/test.svelte-1250c728.js", "chunks/vendor-a533b0b9.js"], "styles": [] }, "src/routes/work.svelte": { "entry": "pages/work.svelte-accd8b5b.js", "css": ["assets/pages/work.svelte-9d97471f.css"], "js": ["pages/work.svelte-accd8b5b.js", "chunks/vendor-a533b0b9.js"], "styles": [] }, "src/routes/try.svelte": { "entry": "pages/try.svelte-6f8dc6a5.js", "css": ["assets/pages/try.svelte-11399192.css"], "js": ["pages/try.svelte-6f8dc6a5.js", "chunks/vendor-a533b0b9.js"], "styles": [] } };
...
var Accordion = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="${"btn svelte-110i3jn"}"${add_attribute("aria-expanded", isOpen, 0)}><p class="${"svelte-110i3jn"}">${escape(entry[0])}</p>
  <svg class="${"svg svelte-110i3jn"}" height="${"12"}" width="${"12"}"><line x1="${"0"}" y1="${"6"}" x2="${"12"}" y2="${"6"}"></line><line x1="${"6"}" y1="${"12"}" x2="${"6"}" y2="${"0"}"></line></svg></div>
...
<div class="${"content-500 svelte-1fzsa8t"}"><h1 class="${"svelte-1fzsa8t"}">Our business is making yours look good.</h1>
  <p class="${"svelte-1fzsa8t"}">We provide brand centred graphic design and web development services to SMEs
    and corporates in Nairobi.
  </p></div>

<div class="${"content svelte-1fzsa8t"}">${validate_component(Swiper, "Swiper").$$render($$result, {
    slidesPerView: 3,
    spaceBetween: 10,
    slidesPerGroup: 1,
    mousewheel: false,
    ...
    default: () => `${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/recent/8.jpg"}" alt="${""}" class="${"svelte-1fzsa8t"}">`
    })}
    ${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/recent/11.jpg"}" alt="${""}" class="${"svelte-1fzsa8t"}">`
    })}
    ${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/recent/9.jpg"}" alt="${""}" class="${"svelte-1fzsa8t"}">`
    })}
    ${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/recent/eaglehr-banners.jpg"}" alt="${""}" class="${"svelte-1fzsa8t"}">`
    })}
    ${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/recent/55.jpg"}" alt="${""}" class="${"svelte-1fzsa8t"}">`
    })}
    ${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/recent/6.jpg"}" alt="${""}" class="${"svelte-1fzsa8t"}">`
    })}
    ${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/recent/liberte.jpg"}" alt="${""}" class="${"svelte-1fzsa8t"}">`
    })}`
  })}</div>

<div class="${"services svelte-1fzsa8t"}"><h2 class="${"svelte-1fzsa8t"}">Our services</h2>
  <div class="${"accordion svelte-1fzsa8t"}">${each$1(Object.entries(data), (entry) => `${validate_component(Accordion, "Accordion").$$render($$result, { entry }, {}, {})}`)}</div></div>

<div class="${"recent svelte-1fzsa8t"}"><h2 class="${"svelte-1fzsa8t"}">Recent projects</h2>
  <p class="${"recent__text svelte-1fzsa8t"}">We handle many full brand development projects. Below we showcase the ones
    we completed recently
  </p></div>

<div class="${"four-way-grid svelte-1fzsa8t"}">${validate_component(Recent, "Recent").$$render($$result, {}, {}, {})}</div>

<div class="${"clients svelte-1fzsa8t"}"><h2 class="${"svelte-1fzsa8t"}">Our clients</h2>
  <p class="${"svelte-1fzsa8t"}">We work with companies of all sizes. Start-ups, SMES or corporates.
    Regardless of your size our goal is always the same, do work that helps you
    stand out in the market place.
  </p></div>

<div class="${"logos svelte-1fzsa8t"}">${validate_component(Swiper, "Swiper").$$render($$result, {
    slidesPerView: 3,
    spaceBetween: 20,
    slidesPerGroup: 1,
    mousewheel: false,
    ...
    default: () => `${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/logos/amsco.png"}" alt="${"amsco logo"}" class="${"svelte-1fzsa8t"}">`
    })}
    
    ${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/logos/anchor.png"}" alt="${"Anchor builders logo"}" class="${"svelte-1fzsa8t"}">`
    })}
    ${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/logos/strathmore.png"}" alt="${"Strathmore University logo"}" class="${"svelte-1fzsa8t"}">`
    })}
    ${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/logos/eaglehr.png"}" alt="${"Eaglehr kenya logo"}" class="${"svelte-1fzsa8t"}">`
    })}
    ${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/logos/absa.png"}" alt="${"absa bank logo"}" class="${"svelte-1fzsa8t"}">`
    })}
    ${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/logos/farmhouse.png"}" alt="${"farmhouse sacco logo"}" class="${"svelte-1fzsa8t"}">`
    })}`
  })}
</div>`;
});
...
<div class="${"content-500 svelte-1gitznl"}"><h1>Anchor homes branding.</h1>
  <p class="${"svelte-1gitznl"}">Anchor approached us to imagine their branding. For this project we wanted
    to create a brand that is emotional and caring. A brand that lets you know
    we&#39;ve got your back.
  </p>
  </div>

<article class="${"width bg-color img-width hero svelte-1gitznl"}"><div class="${"svelte-1gitznl"}"><img src="${"img/recent/anchor hero.png"}" alt="${"anchor"}" class="${"svelte-1gitznl"}"></div></article>

<div class="${"intersection width svelte-1gitznl"}"><h2 class="${"svelte-1gitznl"}">Our identity</h2>
  <p class="${"svelte-1gitznl"}">To establish Anchor&#39;s identity we, we selected brand colours and fonts. We
    created brand patterns and established guides on how to use the logo, images
    and colours. Put together these elements create a unique and recognisable
    brand.
  </p></div>

<div class="${"width work-wrapper svelte-1gitznl"}"><div class="${"recent-work"}"><section class="${"two-way-grid"}">${validate_component(TwoWayGrid, "TwoWayGrid").$$render($$result, {}, {}, {
    right: () => `<div slot="${"right"}" class="${"img-wrapper svelte-1gitznl"}"><img src="${"img/recent/1.jpg"}" alt="${"eaglehr"}" class="${"svelte-1gitznl"}"></div>`,
    left: () => `<div slot="${"left"}" class="${"img-wrapper svelte-1gitznl"}"><img src="${"img/recent/2.jpg"}" alt="${"eaglehr"}" class="${"svelte-1gitznl"}"></div>`
  })}</section></div></div>

<div class="${"width work-wrapper svelte-1gitznl"}"><div class="${"recent-work"}"><section class="${"two-way-grid"}">${validate_component(TwoWayGrid, "TwoWayGrid").$$render($$result, {}, {}, {
    right: () => `<div slot="${"right"}" class="${"img-wrapper svelte-1gitznl"}"><img src="${"img/recent/anchor advert.jpg"}" alt="${"anchor construction advert"}" class="${"svelte-1gitznl"}"></div>`,
    left: () => `<div slot="${"left"}" class="${"img-wrapper svelte-1gitznl"}"><img src="${"img/recent/anchor-elements.jpg"}" alt="${"anchor"}" class="${"svelte-1gitznl"}"></div>`
  })}</section></div></div>

<div class="${"intersection width svelte-1gitznl"}"><h2 class="${"svelte-1gitznl"}">Identity and application</h2>
  <p class="${"svelte-1gitznl"}">Anchor&#39;s logo is versatile and adaptable in it&#39;s application. It works well
    in various forms of marketing communication.
  </p></div>

<div class="${"bg-white width svelte-1gitznl"}"><img src="${"img/recent/branded.png"}" alt="${"anchor one"}" class="${"svelte-1gitznl"}"></div>

<div class="${"width img-width three-way-grid svelte-1gitznl"}">${validate_component(ThreeWayGrid, "ThreeWayGrid").$$render($$result, {}, {}, {
    right: () => `<img slot="${"right"}" src="${"img/recent/7.jpg"}" alt="${"anchor tshirt branding"}" class="${"svelte-1gitznl"}">`,
    center: () => `<img slot="${"center"}" src="${"img/recent/anchor-cap.jpg"}" alt="${"anchor one"}" class="${"svelte-1gitznl"}">`,
    left: () => `<img slot="${"left"}" src="${"img/recent/carrier bags.jpg"}" alt="${"anchor one"}" class="${"svelte-1gitznl"}">`
  })}</div>

<div class="${"width work-wrapper svelte-1gitznl"}"><div class="${"recent-work"}"><section class="${"two-way-grid"}">${validate_component(TwoWayGrid, "TwoWayGrid").$$render($$result, {}, {}, {
    right: () => `<div slot="${"right"}" class="${"img-wrapper svelte-1gitznl"}"><img src="${"img/recent/anchor-helmet.jpg"}" alt="${"anchor helmet"}" class="${"svelte-1gitznl"}"></div>`,
    left: () => `<div slot="${"left"}" class="${"img-wrapper svelte-1gitznl"}"><img src="${"img/recent/hanging-banner.jpg"}" alt="${"anchor hanging banner"}" class="${"svelte-1gitznl"}"></div>`
  })}</section></div>
</div>`;
});
