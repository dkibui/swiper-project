...
function init(settings = default_settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: assets + "/_app/start-452b4f25.js",
      css: [assets + "/_app/assets/start-61d1577b.css"],
      js: [assets + "/_app/start-452b4f25.js", assets + "/_app/chunks/vendor-a533b0b9.js"]
    },
    fetched: void 0,
    floc: false,
...
<div class="${"intersection svelte-68vhsd"}"><h2 class="${"svelte-68vhsd"}">Brand application for Anchor homes.</h2>
  <p class="${"svelte-68vhsd"}">Our approach and implementation for this project was based on simplicity and
    clarity.
  </p></div>

<div class="${"width work-wrapper svelte-68vhsd"}"><div class="${"recent-work"}"><section class="${"two-way-grid"}">${validate_component(TwoWayGrid, "TwoWayGrid").$$render($$result, {}, {}, {
    right: () => `<div slot="${"right"}" class="${"img-wrapper svelte-68vhsd"}"><img src="${"img/recent/table-calendar.jpg"}" alt="${"eaglehr"}" class="${"svelte-68vhsd"}"></div>`,
    left: () => `<div slot="${"left"}" class="${"img-wrapper svelte-68vhsd"}"><img src="${"img/recent/anchor advert.jpg"}" alt="${"anchor construction advert"}" class="${"svelte-68vhsd"}"></div>`
  })}</section></div></div>
