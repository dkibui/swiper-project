...
function init(settings = default_settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: assets + "/_app/start-19800fa9.js",
      css: [assets + "/_app/assets/start-61d1577b.css"],
      js: [assets + "/_app/start-19800fa9.js", assets + "/_app/chunks/vendor-336043de.js"]
    },
    fetched: void 0,
    floc: false,
...
var css$8 = {
  code: ".menu.svelte-1e6855p.svelte-1e6855p{width:87%;margin:0 auto;display:flex;align-items:center;justify-content:space-between;margin-top:1.3rem}.menu.svelte-1e6855p img.svelte-1e6855p{display:block;height:36px}.container.svelte-1e6855p.svelte-1e6855p{cursor:pointer}.bar1.svelte-1e6855p.svelte-1e6855p,.bar2.svelte-1e6855p.svelte-1e6855p,.bar3.svelte-1e6855p.svelte-1e6855p{width:32px;height:3px;background-color:var(--text-color);margin:8px 0;transition:0.4s}.change.svelte-1e6855p .bar1.svelte-1e6855p{-webkit-transform:rotate(-45deg) translate(-9px, 6px);transform:rotate(-45deg) translate(-9px, 6px)}.change.svelte-1e6855p .bar2.svelte-1e6855p{opacity:0}.change.svelte-1e6855p .bar3.svelte-1e6855p{-webkit-transform:rotate(45deg) translate(-8px, -8px);transform:rotate(45deg) translate(-8px, -8px)}.sidenav.svelte-1e6855p.svelte-1e6855p{height:100%;width:0;position:fixed;z-index:9;top:0;left:0;background-color:var(--primary-color);opacity:0.98999;overflow-x:hidden;padding-top:60px;transition:0.5s}.sidenav.svelte-1e6855p a.svelte-1e6855p{padding:28px 8px 28px 32px;text-decoration:none;font-size:20px;color:var(--text-color);display:block;transition:0.3s;border-bottom:1px solid var(--secondary-color)}.sidenav.svelte-1e6855p a.svelte-1e6855p:first-child{padding-top:19px}.sidenav.svelte-1e6855p a.svelte-1e6855p:first-child,.sidenav.svelte-1e6855p a.svelte-1e6855p:last-child{border-bottom:none}.sidenav.svelte-1e6855p a.svelte-1e6855p:hover{color:#f1f1f1;color:var(--accent-color)}.sidenav.svelte-1e6855p .closebtn.svelte-1e6855p{position:absolute;top:0;right:25px;font-size:36px;margin-left:50px}.open.svelte-1e6855p.svelte-1e6855p{width:70%}@media(min-width: 768px){.container.svelte-1e6855p.svelte-1e6855p{display:none}.navigation.svelte-1e6855p.svelte-1e6855p{width:90%;max-width:1600px;margin:auto;display:flex;justify-content:space-between;align-items:center;position:relative;height:fit-content;margin-top:0.75rem}.menu.svelte-1e6855p.svelte-1e6855p{margin:0}.sidenav.svelte-1e6855p.svelte-1e6855p{display:flex;height:100%;width:100%;position:static;background-color:transparent;overflow-x:hidden;padding-top:0;transition:0s;justify-content:flex-end}.sidenav.svelte-1e6855p a.svelte-1e6855p{font-size:18px}.sidenav.svelte-1e6855p a.svelte-1e6855p:first-child{display:none}.sidenav.svelte-1e6855p a.svelte-1e6855p{margin:0;padding:0;padding-left:2.4rem}.sidenav.svelte-1e6855p .closebtn.svelte-1e6855p{position:static;top:0;right:0;font-size:36px;margin-left:0}}",
...
var Canvas = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="${"navigation svelte-1e6855p"}"><div class="${"menu svelte-1e6855p"}"><div class="${"logo"}"><a href="${"/"}"><img src="${"img/visign-logo.svg"}" alt="${"visign kenya logo"}" class="${"svelte-1e6855p"}"></a></div>
    <div class="${["container svelte-1e6855p", ""].join(" ").trim()}"><div class="${"bar1 svelte-1e6855p"}"></div>
      <div class="${"bar2 svelte-1e6855p"}"></div>
      <div class="${"bar3 svelte-1e6855p"}"></div></div></div>

  <div id="${"mySidenav"}" class="${["sidenav svelte-1e6855p", ""].join(" ").trim()}"><a href="${"#a"}" class="${"closebtn svelte-1e6855p"}">\xD7</a>
    <a href="${"/"}" class="${"svelte-1e6855p"}">Home</a>
    <a href="${"/about"}" class="${"svelte-1e6855p"}">About</a>
    <a href="${"/work"}" class="${"svelte-1e6855p"}">Work</a>
