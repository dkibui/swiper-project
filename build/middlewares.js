...
function init(settings = default_settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: assets + "/_app/start-d08d28ce.js",
      css: [assets + "/_app/assets/start-61d1577b.css"],
      js: [assets + "/_app/start-d08d28ce.js", assets + "/_app/chunks/vendor-336043de.js"]
    },
    fetched: void 0,
    floc: false,
...
var metadata_lookup = { "src/routes/__layout.svelte": { "entry": "pages/__layout.svelte-7f4729e9.js", "css": ["assets/pages/__layout.svelte-57f524a6.css"], "js": ["pages/__layout.svelte-7f4729e9.js", "chunks/vendor-336043de.js"], "styles": [] }, ".svelte-kit/build/components/error.svelte": { "entry": "error.svelte-086a6be9.js", "css": [], "js": ["error.svelte-086a6be9.js", "chunks/vendor-336043de.js"], "styles": [] }, "src/routes/index.svelte": { "entry": "pages/index.svelte-e3d81aca.js", "css": ["assets/pages/index.svelte-04ceda93.css", "assets/pagination.min-4d3a60e0.css"], "js": ["pages/index.svelte-e3d81aca.js", "chunks/vendor-336043de.js"], "styles": [] }, "src/routes/collapsible.svelte": { "entry": "pages/collapsible.svelte-1a568d6c.js", "css": [], "js": ["pages/collapsible.svelte-1a568d6c.js", "chunks/vendor-336043de.js"], "styles": [] }, "src/routes/about.svelte": { "entry": "pages/about.svelte-789ecf34.js", "css": ["assets/pages/about.svelte-de8cddf4.css", "assets/pagination.min-4d3a60e0.css"], "js": ["pages/about.svelte-789ecf34.js", "chunks/vendor-336043de.js"], "styles": [] }, "src/routes/menu.svelte": { "entry": "pages/menu.svelte-9774df1f.js", "css": [], "js": ["pages/menu.svelte-9774df1f.js", "chunks/vendor-336043de.js"], "styles": [] }, "src/routes/work.svelte": { "entry": "pages/work.svelte-b29bf66f.js", "css": ["assets/pages/work.svelte-b11f963d.css"], "js": ["pages/work.svelte-b29bf66f.js", "chunks/vendor-336043de.js"], "styles": [] } };
...
var css$7 = {
  code: "main.svelte-1movnro.svelte-1movnro{flex:1;display:flex;flex-direction:column;width:92%;margin:0 auto;box-sizing:border-box}footer.svelte-1movnro.svelte-1movnro{display:flex;flex-direction:column;justify-content:center;align-items:center;padding-top:var(--top-margin-mobile)}footer.svelte-1movnro a.svelte-1movnro{font-weight:bold;text-decoration:none}footer.svelte-1movnro p.svelte-1movnro{width:92%;max-width:1024px;margin:0 auto}.social-icons.svelte-1movnro.svelte-1movnro{display:grid;grid-template-columns:repeat(3, 1fr);margin-top:2.5rem;margin-bottom:1.5rem;gap:1rem}.social-icons.svelte-1movnro img.svelte-1movnro{display:block;width:100%;max-width:28px}@media(min-width: 480px){}",
  map: `{"version":3,"file":"__layout.svelte","sources":["__layout.svelte"],"sourcesContent":["<script>\\n  import Canvas from '$lib/header/Canvas.svelte'\\n  import '../app.css'\\n<\/script>\\n\\n<Canvas />\\n\\n<main>\\n  <slot />\\n</main>\\n\\n<footer>\\n  <p>\\n    Thank you for visiting. <a href=\\"mailto:dkibui@visign.co.ke\\">\\n      Send us an email\\n    </a>\\n    to see how we can help.\\n  </p>\\n  <div class=\\"social-icons\\">\\n    <a href=\\"https://www.behance.net\\">\\n      <img src=\\"img/social/behance.png\\" alt=\\"behance logo\\" />\\n    </a>\\n    <a href=\\"https://www.instagram.com\\">\\n      <img src=\\"img/social/instagram.png\\" alt=\\"instagram logo\\" />\\n    </a>\\n    <a href=\\"https://www.twitter.com\\">\\n      <img src=\\"img/social/twitter.png\\" alt=\\"twitter logo\\" />\\n    </a>\\n  </div>\\n</footer>\\n\\n<style>\\n  main {\\n    flex: 1;\\n    display: flex;\\n    flex-direction: column;\\n    width: 92%;\\n    margin: 0 auto;\\n    box-sizing: border-box;\\n  }\\n\\n  footer {\\n    display: flex;\\n    flex-direction: column;\\n    justify-content: center;\\n    align-items: center;\\n    padding-top: var(--top-margin-mobile);\\n  }\\n\\n  footer a {\\n    font-weight: bold;\\n    text-decoration: none;\\n  }\\n\\n  footer p {\\n    width: 92%;\\n    max-width: 1024px;\\n    margin: 0 auto;\\n  }\\n\\n  .social-icons {\\n    display: grid;\\n    grid-template-columns: repeat(3, 1fr);\\n    margin-top: 2.5rem;\\n    margin-bottom: 1.5rem;\\n    gap: 1rem;\\n  }\\n\\n  .social-icons img {\\n    display: block;\\n    width: 100%;\\n    max-width: 28px;\\n  }\\n\\n  @media (min-width: 480px) {\\n    /* footer {\\n      padding: 40px 0;\\n    } */\\n  }\\n</style>\\n"],"names":[],"mappings":"AAgCE,IAAI,8BAAC,CAAC,AACJ,IAAI,CAAE,CAAC,CACP,OAAO,CAAE,IAAI,CACb,cAAc,CAAE,MAAM,CACtB,KAAK,CAAE,GAAG,CACV,MAAM,CAAE,CAAC,CAAC,IAAI,CACd,UAAU,CAAE,UAAU,AACxB,CAAC,AAED,MAAM,8BAAC,CAAC,AACN,OAAO,CAAE,IAAI,CACb,cAAc,CAAE,MAAM,CACtB,eAAe,CAAE,MAAM,CACvB,WAAW,CAAE,MAAM,CACnB,WAAW,CAAE,IAAI,mBAAmB,CAAC,AACvC,CAAC,AAED,qBAAM,CAAC,CAAC,eAAC,CAAC,AACR,WAAW,CAAE,IAAI,CACjB,eAAe,CAAE,IAAI,AACvB,CAAC,AAED,qBAAM,CAAC,CAAC,eAAC,CAAC,AACR,KAAK,CAAE,GAAG,CACV,SAAS,CAAE,MAAM,CACjB,MAAM,CAAE,CAAC,CAAC,IAAI,AAChB,CAAC,AAED,aAAa,8BAAC,CAAC,AACb,OAAO,CAAE,IAAI,CACb,qBAAqB,CAAE,OAAO,CAAC,CAAC,CAAC,GAAG,CAAC,CACrC,UAAU,CAAE,MAAM,CAClB,aAAa,CAAE,MAAM,CACrB,GAAG,CAAE,IAAI,AACX,CAAC,AAED,4BAAa,CAAC,GAAG,eAAC,CAAC,AACjB,OAAO,CAAE,KAAK,CACd,KAAK,CAAE,IAAI,CACX,SAAS,CAAE,IAAI,AACjB,CAAC,AAED,MAAM,AAAC,YAAY,KAAK,CAAC,AAAC,CAAC,AAI3B,CAAC"}`
};
var _layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css$7);
  return `${validate_component(Canvas, "Canvas").$$render($$result, {}, {}, {})}

<main class="${"svelte-1movnro"}">${slots.default ? slots.default({}) : ``}</main>

<footer class="${"svelte-1movnro"}"><p class="${"svelte-1movnro"}">Thank you for visiting. <a href="${"mailto:dkibui@visign.co.ke"}" class="${"svelte-1movnro"}">Send us an email
    </a>
    to see how we can help.
  </p>
  <div class="${"social-icons svelte-1movnro"}"><a href="${"https://www.behance.net"}" class="${"svelte-1movnro"}"><img src="${"img/social/behance.png"}" alt="${"behance logo"}" class="${"svelte-1movnro"}"></a>
    <a href="${"https://www.instagram.com"}" class="${"svelte-1movnro"}"><img src="${"img/social/instagram.png"}" alt="${"instagram logo"}" class="${"svelte-1movnro"}"></a>
    <a href="${"https://www.twitter.com"}" class="${"svelte-1movnro"}"><img src="${"img/social/twitter.png"}" alt="${"twitter logo"}" class="${"svelte-1movnro"}"></a></div>
</footer>`;
});
...
<div class="${"content-500 svelte-194pirn"}"><h1 class="${"svelte-194pirn"}">Our business is to make yours look good</h1>
  <p class="${"svelte-194pirn"}">We provide brand centred graphic design and web development services to SMEs
    and corporates in Nairobi
  </p></div>

<div class="${"content svelte-194pirn"}">${validate_component(Swiper, "Swiper").$$render($$result, {
    slidesPerView: 3,
    spaceBetween: 10,
    slidesPerGroup: 1,
    mousewheel: false,
    ...
    default: () => `${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/recent/8.jpg"}" alt="${""}" class="${"svelte-194pirn"}">`
    })}
    ${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/recent/2.jpg"}" alt="${""}" class="${"svelte-194pirn"}">`
    })}
    ${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/recent/1.jpg"}" alt="${""}" class="${"svelte-194pirn"}">`
    })}
    ${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/recent/9.jpg"}" alt="${""}" class="${"svelte-194pirn"}">`
    })}
    ${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/recent/5.jpg"}" alt="${""}" class="${"svelte-194pirn"}">`
    })}
    ${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/recent/6.jpg"}" alt="${""}" class="${"svelte-194pirn"}">`
    })}
    ${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/recent/liberte.jpg"}" alt="${""}" class="${"svelte-194pirn"}">`
    })}`
  })}</div>

<div class="${"services svelte-194pirn"}"><h2 class="${"svelte-194pirn"}">Our services</h2>
  <div class="${"accordion svelte-194pirn"}">${each$1(Object.entries(data), (entry) => `${validate_component(Accordion, "Accordion").$$render($$result, { entry }, {}, {})}`)}</div></div>



<div class="${"clients svelte-194pirn"}"><h2 class="${"svelte-194pirn"}">Our clients</h2>
  <p class="${"svelte-194pirn"}">We work with companies of all sizes. Start-ups, SMES or corporates.
    Regardless of your size our goal is always the same, do work that helps you
    stand out in the market place.
  </p></div>

<div class="${"logos svelte-194pirn"}">${validate_component(Swiper, "Swiper").$$render($$result, {
    slidesPerView: 3,
    spaceBetween: 20,
    slidesPerGroup: 1,
    mousewheel: false,
    ...
    default: () => `${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/logos/amsco.png"}" alt="${"amsco logo"}" class="${"svelte-194pirn"}">`
    })}
    
    ${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/logos/anchor.png"}" alt="${"Anchor builders logo"}" class="${"svelte-194pirn"}">`
    })}
    ${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/logos/strathmore.png"}" alt="${"Strathmore University logo"}" class="${"svelte-194pirn"}">`
    })}
    ${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/logos/eaglehr.png"}" alt="${"Eaglehr kenya logo"}" class="${"svelte-194pirn"}">`
    })}
    ${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/logos/absa.png"}" alt="${"absa bank logo"}" class="${"svelte-194pirn"}">`
    })}
    ${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"img/logos/farmhouse.png"}" alt="${"farmhouse sacco logo"}" class="${"svelte-194pirn"}">`
    })}`
  })}
</div>`;
});
